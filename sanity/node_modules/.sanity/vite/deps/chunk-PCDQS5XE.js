...
} from "./chunk-X6NMINOW.js";
import {
  require_react_dom
} from "./chunk-EEBIZHOA.js";
import {
  require_jsx_runtime
...
var require_dist = __commonJS({
  "../node_modules/react-compiler-runtime/dist/index.js"(exports) {
    "use no memo";
    "use strict";
    var React13 = require_react();
    ...
    var React__namespace = _interopNamespaceDefault(React13);
    var _a;
    var _b;
    var { useRef: useRef16, useEffect: useEffect18, isValidElement: isValidElement3 } = React__namespace;
    var ReactSecretInternals = (_a = React__namespace.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE) !== null && _a !== void 0 ? _a : React__namespace.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
    var $empty = Symbol.for("react.memo_cache_sentinel");
    var c3 = typeof ((_b = React__namespace.__COMPILER_RUNTIME) === null || _b === void 0 ? void 0 : _b.c) === "function" ? React__namespace.__COMPILER_RUNTIME.c : function c4(size4) {
      return React__namespace.useMemo(() => {
        const $2 = new Array(size4);
    ...
    function $structuralCheck(oldValue, newValue, variableName, fnName, kind, loc) {
      function error(l2, r2, path, depth) {
        const str = `${fnName}:${loc} [${kind}] ${variableName}${path} changed from ${l2} to ${r2} at depth ${depth}`;
          ...
          if (oldValue2 === null && newValue2 !== null) {
            ...
            if (!(newValue2 instanceof Map)) {
              ...
              for (const [k2, v2] of oldValue2) {
                if (!newValue2.has(k2)) {
                  error(`Map instance with key ${k2}`, `Map instance without key ${k2}`, path, depth);
                } else {
            ...
            if (!(newValue2 instanceof Set)) {
              ...
              for (const v2 of newValue2) {
                if (!oldValue2.has(v2)) {
                  error(`Set instance without element ${v2}`, `Set instance with element ${v2}`, path, depth);
                }
              }
            }
            ...
            if (isValidElement3(oldValue2) !== isValidElement3(newValue2)) {
              error(`type ${isValidElement3(oldValue2) ? "React element" : "object"}`, `type ${isValidElement3(newValue2) ? "React element" : "object"}`, path, depth);
            ...
            for (const key2 in newValue2) {
              if (!(key2 in oldValue2)) {
                error(`object without key ${key2}`, `object with key ${key2}`, path, depth);
              }
            }
            for (const key2 in oldValue2) {
              if (!(key2 in newValue2)) {
                error(`object with key ${key2}`, `object without key ${key2}`, path, depth);
              } else {
...
var THEME_COLOR_CARD_TONES = ["transparent", "default", "primary", "positive", "caution", "critical"];
var THEME_COLOR_STATE_TONES = ["default", "primary", "positive", "caution", "critical"];
...
function resolveBaseColorTones(inputTokens, tone) {
  ...
  return {
    ...
    avatar: {
      gray: merge({
        _hue: "gray"
      }, (_e2 = spec.avatar) == null ? void 0 : _e2["*"], (_f = spec.avatar) == null ? void 0 : _f.gray),
      blue: merge({
        _hue: "blue"
...
function hslToRgb(hsl) {
  const s2 = hsl.s / 100, l2 = hsl.l / 100, c3 = (1 - Math.abs(2 * l2 - 1)) * s2, x2 = c3 * (1 - Math.abs(hsl.h / 60 % 2 - 1)), m3 = l2 - c3 / 2;
  let r2 = 0, g2 = 0, b2 = 0;
  return 0 <= hsl.h && hsl.h < 60 ? (r2 = c3, g2 = x2, b2 = 0) : 60 <= hsl.h && hsl.h < 120 ? (r2 = x2, g2 = c3, b2 = 0) : 120 <= hsl.h && hsl.h < 180 ? (r2 = 0, g2 = c3, b2 = x2) : 180 <= hsl.h && hsl.h < 240 ? (r2 = 0, g2 = x2, b2 = c3) : 240 <= hsl.h && hsl.h < 300 ? (r2 = x2, g2 = 0, b2 = c3) : 300 <= hsl.h && hsl.h < 360 && (r2 = c3, g2 = 0, b2 = x2), {
...
function prefix(value, length2, children) {
  switch (hash(value, length2)) {
    ...
    case 5152:
    case 5920:
      return replace(value, /(.+?):(\d+)(\s*\/\s*(span)?\s*(\d+))?(.*)/, function(_2, a2, b2, c3, d, e, f2) {
        return MS + a2 + ":" + b2 + f2 + (c3 ? MS + a2 + "-span:" + (d ? e : +e - +b2) + f2 : "") + value;
      });
    case 4949:
  ...
  for (var n, o2 = (null !== (n = t.textContent) && void 0 !== n ? n : "").split(g), r2 = [], s2 = 0, i2 = o2.length; s2 < i2; s2++) {
    ...
    if (a2) {
      ...
      if (c3) {
        ...
        0 !== l2 && (we(u2, l2), Ne(e, u2, c3[3]), e.getTag().insertRules(l2, r2)), r2.length = 0;
      } else
        r2.push(a2);
    }
  }
...
function Fe(e) {
  var t, n, o2, r2 = void 0 === e ? C : e, s2 = r2.options, i2 = void 0 === s2 ? C : s2, a2 = r2.plugins, c3 = void 0 === a2 ? _ : a2, l2 = function(e2, o3, r3) {
  ...
  var p2 = function(e2, r3, s3, a3) {
    ...
    var c4 = e2.replace(xe, ""), l3 = compile(s3 || r3 ? "".concat(s3, " ").concat(r3, " { ").concat(c4, " }") : c4);
  ...
  return p2.hash = c3.length ? c3.reduce(function(e2, t2) {
...
function Ye(e) {
  var t = (0, import_react.useState)(e.stylisPlugins), n = t[0], r2 = t[1], c3 = Ge().styleSheet, l2 = (0, import_react.useMemo)(function() {
    var t2 = c3;
...
var Qe = function() {
  ...
  return e.prototype.generateAndInjectStyles = function(e2, t, n) {
    ...
    if (this.isStatic && !n.hash)
      ...
      for (var a2 = M(this.baseHash, n.hash), c3 = "", l2 = 0; l2 < this.rules.length; l2++) {
...
function it(e, r2, s2) {
  var i2 = se(e), a2 = e, c3 = !L(e), p2 = r2.attrs, d = void 0 === p2 ? _ : p2, h = r2.componentId, f2 = void 0 === h ? function(e2, t) {
  ...
  function O2(e2, r3) {
    return function(e3, r4, s3) {
      var i3 = e3.attrs, a3 = e3.componentStyle, c4 = e3.defaultProps, p3 = e3.foldedComponentIds, d2 = e3.styledComponentId, h2 = e3.target, f3 = import_react.default.useContext(et), m4 = Ge(), y3 = e3.shouldForwardProp || m4.shouldForwardProp;
      ...
      var v2 = I(r4, f3, c4) || C, g3 = function(e4, n, o2) {
        for (var r5, s4 = __assign(__assign({}, n), { className: void 0, theme: o2 }), i4 = 0; i4 < e4.length; i4 += 1) {
          ...
          for (var c5 in a4)
            s4[c5] = "className" === c5 ? ie(s4[c5], a4[c5]) : "style" === c5 ? __assign(__assign({}, s4[c5]), a4[c5]) : a4[c5];
        }
...
function ft(n) {
  ...
  var i2 = lt.apply(void 0, __spreadArray([n], r2, false)), a2 = "sc-global-".concat($(JSON.stringify(i2))), c3 = new ht(i2, a2);
  P(a2);
  var l2 = function(e) {
...
var cubicBezierAsString = ([a2, b2, c3, d]) => `cubic-bezier(${a2}, ${b2}, ${c3}, ${d})`;
...
var splitColor = (aName, bName, cName) => (v2) => {
  if (!isString(v2))
    return v2;
  const [a2, b2, c3, alpha2] = v2.match(floatRegex);
  return {
    [aName]: parseFloat(a2),
    [bName]: parseFloat(b2),
    [cName]: parseFloat(c3),
...
function PopChild({ children, isPresent }) {
  ...
  const size4 = (0, import_react22.useRef)({
    width: 0,
    height: 0,
    top: 0,
    left: 0
...
function useEffectEvent(fn) {
  ...
  return (0, import_react47.useInsertionEffect)(() => {
    ref.current = fn;
  }, [fn]), (0, import_react47.useCallback)((...args) => {
...
function useArrayProp(val, defaultVal) {
  const __perf_hash__ = (0, import_react48.useMemo)(() => JSON.stringify(val ?? defaultVal), [defaultVal, val]);
...
function useClickOutsideEvent(listener, t0, boundaryElement) {
  const $2 = (0, import_react_compiler_runtime.c)(8), elementsArg = t0 === void 0 ? _temp$6 : t0;
  let t1;
  $2[0] !== listener || $2[1] !== boundaryElement || $2[2] !== elementsArg ? (t1 = (evt) => {
    if (!listener)
      return;
    ...
    for (const el of elements)
      if (el && (target === el || el.contains(target)))
        return;
    listener(evt);
  }, $2[0] = listener, $2[1] = boundaryElement, $2[2] = elementsArg, $2[3] = t1) : t1 = $2[3];
  ...
  }, t3 = [hasListener, onEvent], $2[4] = hasListener, $2[5] = onEvent, $2[6] = t2, $2[7] = t3) : (t2 = $2[6], t3 = $2[7]), (0, import_react48.useEffect)(t2, t3), (0, import_react48.useDebugValue)(listener ? "MouseDown On" : "MouseDown Off");
}
function _temp$6() {
  return EMPTY_ARRAY;
}
function useCustomValidity(ref, customValidity) {
  ...
  let t0;
  $2[0] !== ref.current || $2[1] !== customValidity ? (t0 = () => {
    var _a;
    (_a = ref.current) == null ? void 0 : _a.setCustomValidity(customValidity || "");
  }, $2[0] = ref.current, $2[1] = customValidity, $2[2] = t0) : t0 = $2[2];
  let t1;
  $2[3] !== customValidity || $2[4] !== ref ? (t1 = [customValidity, ref], $2[3] = customValidity, $2[4] = ref, $2[5] = t1) : t1 = $2[5], (0, import_react48.useEffect)(t0, t1);
}
var resizeObservers = [];
...
function useElementSize(element) {
  const $2 = (0, import_react_compiler_runtime.c)(3), [size22, setSize] = (0, import_react48.useState)(null);
  let t0, t1;
  return $2[0] !== element ? (t0 = () => {
    if (element)
      return _elementSizeObserver.subscribe(element, setSize);
  }, t1 = [element], $2[0] = element, $2[1] = t0, $2[2] = t1) : (t0 = $2[1], t1 = $2[2]), (0, import_react48.useEffect)(t0, t1), size22;
}
...
function useGlobalKeyDown(onKeyDown) {
  ...
  let t0, t1;
  return $2[0] !== onKeyDown ? (t0 = () => (addEventListener("keydown", onKeyDown), () => removeEventListener("keydown", onKeyDown)), t1 = [onKeyDown], $2[0] = onKeyDown, $2[1] = t0, $2[2] = t1) : (t0 = $2[1], t1 = $2[2]), (0, import_react48.useEffect)(t0, t1);
}
function useMatchMedia(mediaQueryString, getServerSnapshot2) {
  ...
  return (0, import_react48.useDebugValue)(mediaQueryString), (0, import_react48.useSyncExternalStore)(subscribe2, getSnapshot, getServerSnapshot2);
}
...
function createGlobalScopedContext(key2, defaultValue) {
  ...
  return typeof document > "u" ? (0, import_react48.createContext)(defaultValue) : (globalScope[symbol] = globalScope[symbol] || (0, import_react48.createContext)(defaultValue), globalScope[symbol]);
}
var ThemeContext = createGlobalScopedContext("@sanity/ui/context/theme", null);
function ThemeProvider(props) {
  const $2 = (0, import_react_compiler_runtime.c)(15), parentTheme = (0, import_react48.useContext)(ThemeContext), {
    children
  ...
  if (!theme) {
    let t22;
    return $2[8] === Symbol.for("react.memo_cache_sentinel") ? (t22 = (0, import_jsx_runtime.jsx)("pre", { children: 'ThemeProvider: no "theme" property provided' }), $2[8] = t22) : t22 = $2[8], t22;
  }
  let t2;
  $2[9] !== theme || $2[10] !== children ? (t2 = (0, import_jsx_runtime.jsx)(ot, { theme, children }), $2[9] = theme, $2[10] = children, $2[11] = t2) : t2 = $2[11];
  let t3;
  return $2[12] !== themeContext || $2[13] !== t2 ? (t3 = (0, import_jsx_runtime.jsx)(ThemeContext.Provider, { value: themeContext, children: t2 }), $2[12] = themeContext, $2[13] = t2, $2[14] = t3) : t3 = $2[14], t3;
}
ThemeProvider.displayName = "ThemeProvider";
function useRootTheme() {
  const value = (0, import_react48.useContext)(ThemeContext);
  if (!value)
...
function ThemeColorProvider(props) {
  ...
  let t1;
  return $2[0] !== t0 || $2[1] !== root.theme || $2[2] !== tone || $2[3] !== children ? (t1 = (0, import_jsx_runtime.jsx)(ThemeProvider, { scheme: t0, theme: root.theme, tone, children }), $2[0] = t0, $2[1] = root.theme, $2[2] = tone, $2[3] = children, $2[4] = t1) : t1 = $2[4], t1;
}
...
function useMediaIndex() {
  ...
  const store = t0;
  return (0, import_react48.useSyncExternalStore)(store.subscribe, store.getSnapshot, getServerSnapshot);
}
...
var SpanWithTextOverflow$2 = dt.span`
  ...
  overflow: clip;
`;
var Label = (0, import_react48.forwardRef)(function(props, ref) {
  ...
  $2[0] !== props ? ({
    ...
    weight,
    ...restProps
  } = props, $2[0] = props, $2[1] = t0, $2[2] = t1, $2[3] = childrenProp, $2[4] = textOverflow, $2[5] = align, $2[6] = restProps, $2[7] = accent, $2[8] = weight) : (t0 = $2[1], t1 = $2[2], childrenProp = $2[3], textOverflow = $2[4], align = $2[5], restProps = $2[6], accent = $2[7], weight = $2[8]);
  const muted = t0 === void 0 ? false : t0, size22 = t1 === void 0 ? 2 : t1;
  let children = childrenProp;
  if (textOverflow === "ellipsis") {
    let t22;
    $2[9] !== children ? (t22 = (0, import_jsx_runtime.jsx)(SpanWithTextOverflow$2, { children }), $2[9] = children, $2[10] = t22) : t22 = $2[10], children = t22;
  } else {
    let t22;
    $2[11] !== children ? (t22 = (0, import_jsx_runtime.jsx)("span", { children }), $2[11] = children, $2[12] = t22) : t22 = $2[12], children = t22;
  }
  const t2 = useArrayProp(align), t3 = useArrayProp(size22);
  let t4;
  return $2[13] !== restProps || $2[14] !== accent || $2[15] !== t2 || $2[16] !== muted || $2[17] !== t3 || $2[18] !== weight || $2[19] !== ref || $2[20] !== children ? (t4 = (0, import_jsx_runtime.jsx)(Root$C, { "data-ui": "Label", ...restProps, $accent: accent, $align: t2, $muted: muted, $size: t3, $weight: weight, ref, children }), $2[13] = restProps, $2[14] = accent, $2[15] = t2, $2[16] = muted, $2[17] = t3, $2[18] = weight, $2[19] = ref, $2[20] = children, $2[21] = t4) : t4 = $2[21], t4;
});
...
var Root$B = dt.div(responsiveAvatarSizeStyle, avatarStyle.root);
...
var Avatar = (0, import_react48.forwardRef)(function(props, ref) {
  const $2 = (0, import_react_compiler_runtime.c)(53);
  ...
  $2[0] !== props ? ({
    ...
    size: t2,
    ...restProps
  } = props, $2[0] = props, $2[1] = t0, $2[2] = t1, $2[3] = t2, $2[4] = asProp, $2[5] = animateArrowFrom, $2[6] = arrowPositionProp, $2[7] = src, $2[8] = onImageLoadError, $2[9] = __unstable_hideInnerStroke, $2[10] = initials, $2[11] = restProps, $2[12] = title) : (t0 = $2[1], t1 = $2[2], t2 = $2[3], asProp = $2[4], animateArrowFrom = $2[5], arrowPositionProp = $2[6], src = $2[7], onImageLoadError = $2[8], __unstable_hideInnerStroke = $2[9], initials = $2[10], restProps = $2[11], title = $2[12]);
  const color3 = t0 === void 0 ? "gray" : t0, status = t1 === void 0 ? "online" : t1, sizeProp = t2 === void 0 ? 1 : t2, {
    avatar
  } = useTheme_v2(), as = import_react_is.default.isValidElementType(asProp) ? asProp : "div", size22 = useArrayProp(sizeProp), _sizeRem = (avatar.sizes[size22[0]] || avatar.sizes[0]).size, _radius = _sizeRem / 2, elementId = (0, import_react48.useId)(), [arrowPosition, setArrowPosition] = (0, import_react48.useState)(animateArrowFrom || arrowPositionProp || "inside"), [imageFailed, setImageFailed] = (0, import_react48.useState)(false), imageId = `avatar-image-${elementId}`;
  let t3, t4;
  ...
  }, t4 = [arrowPosition, arrowPositionProp], $2[13] = arrowPosition, $2[14] = arrowPositionProp, $2[15] = t3, $2[16] = t4) : (t3 = $2[15], t4 = $2[16]), (0, import_react48.useEffect)(t3, t4);
  let t5, t6;
  $2[17] !== src ? (t5 = () => {
    src && setImageFailed(false);
  }, t6 = [src], $2[17] = src, $2[18] = t5, $2[19] = t6) : (t5 = $2[18], t6 = $2[19]), (0, import_react48.useEffect)(t5, t6);
  let t7;
  ...
  if ($2[22] !== size22) {
    let t102;
    $2[24] === Symbol.for("react.memo_cache_sentinel") ? (t102 = (s2) => s2 === 1 ? 1 : s2 === 2 ? 3 : s2 === 3 ? 5 : 0, $2[24] = t102) : t102 = $2[24], t9 = size22.map(t102), $2[22] = size22, $2[23] = t9;
  } else
    t9 = $2[23];
  t8 = t9;
  const initialsSize = t8, t10 = typeof as == "string" ? as : void 0;
  let t11;
  $2[25] !== color3 ? (t11 = (0, import_jsx_runtime.jsx)(Arrow$1, { children: (0, import_jsx_runtime.jsx)("svg", { width: "11", height: "7", viewBox: "0 0 11 7", fill: "none", children: (0, import_jsx_runtime.jsx)("path", { d: "M6.67948 1.50115L11 7L0 7L4.32052 1.50115C4.92109 0.736796 6.07891 0.736795 6.67948 1.50115Z", fill: color3 }) }) }), $2[25] = color3, $2[26] = t11) : t11 = $2[26];
  let t12;
  $2[27] !== imageFailed || $2[28] !== src || $2[29] !== _sizeRem || $2[30] !== handleImageError || $2[31] !== imageId || $2[32] !== _radius || $2[33] !== __unstable_hideInnerStroke ? (t12 = !imageFailed && src && (0, import_jsx_runtime.jsxs)(Image, { viewBox: `0 0 ${_sizeRem} ${_sizeRem}`, fill: "none", children: [
  ...
  ] }), $2[27] = imageFailed, $2[28] = src, $2[29] = _sizeRem, $2[30] = handleImageError, $2[31] = imageId, $2[32] = _radius, $2[33] = __unstable_hideInnerStroke, $2[34] = t12) : t12 = $2[34];
  let t13;
  $2[35] !== imageFailed || $2[36] !== src || $2[37] !== initials || $2[38] !== initialsSize ? (t13 = (imageFailed || !src) && initials && (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(Initials, { children: (0, import_jsx_runtime.jsx)(InitialsLabel, { forwardedAs: "span", size: initialsSize, weight: "medium", children: initials }) }) }), $2[35] = imageFailed, $2[36] = src, $2[37] = initials, $2[38] = initialsSize, $2[39] = t13) : t13 = $2[39];
  let t14;
  return $2[40] !== as || $2[41] !== t10 || $2[42] !== restProps || $2[43] !== color3 || $2[44] !== size22 || $2[45] !== title || $2[46] !== arrowPosition || $2[47] !== status || $2[48] !== ref || $2[49] !== t11 || $2[50] !== t12 || $2[51] !== t13 ? (t14 = (0, import_jsx_runtime.jsxs)(Root$B, { as, "data-as": t10, "data-ui": "Avatar", ...restProps, $color: color3, $size: size22, "aria-label": title, "data-arrow-position": arrowPosition, "data-status": status, ref, title, children: [
    t11,
    t12,
    t13
  ] }), $2[40] = as, $2[41] = t10, $2[42] = restProps, $2[43] = color3, $2[44] = size22, $2[45] = title, $2[46] = arrowPosition, $2[47] = status, $2[48] = ref, $2[49] = t11, $2[50] = t12, $2[51] = t13, $2[52] = t14) : t14 = $2[52], t14;
});
...
var Root$A = dt.div(_responsiveAvatarCounterSizeStyle, _avatarCounterBaseStyle);
var AvatarCounter = (0, import_react48.forwardRef)(function(props, ref) {
  ...
  if ($2[0] !== size22) {
    let t32;
    $2[2] === Symbol.for("react.memo_cache_sentinel") ? (t32 = (s2) => s2 === 1 ? 1 : s2 === 2 ? 3 : s2 === 3 ? 5 : 0, $2[2] = t32) : t32 = $2[2], t2 = size22.map(t32), $2[0] = size22, $2[1] = t2;
  } else
    t2 = $2[1];
  t1 = t2;
  const fontSize2 = t1;
  let t3;
  $2[3] !== fontSize2 || $2[4] !== count ? (t3 = (0, import_jsx_runtime.jsx)(Label, { as: "span", size: fontSize2, weight: "medium", children: count }), $2[3] = fontSize2, $2[4] = count, $2[5] = t3) : t3 = $2[5];
  let t4;
  return $2[6] !== size22 || $2[7] !== ref || $2[8] !== t3 ? (t4 = (0, import_jsx_runtime.jsx)(Root$A, { $size: size22, "data-ui": "AvatarCounter", ref, children: t3 }), $2[6] = size22, $2[7] = ref, $2[8] = t3, $2[9] = t4) : t4 = $2[9], t4;
});
...
var AvatarStack = (0, import_react48.forwardRef)(function(props, ref) {
  const {
    children: childrenProp,
    maxLength: maxLengthProp = 4,
    size: sizeProp = 1,
    ...restProps
  } = props, children = (0, import_react48.useMemo)(() => import_react48.Children.toArray(childrenProp).filter(import_react48.isValidElement), [childrenProp]), maxLength = Math.max(maxLengthProp, 0), size22 = useArrayProp(sizeProp), len = children.length, visibleCount = maxLength - 1, extraCount = len - visibleCount, visibleChildren = extraCount > 1 ? children.slice(extraCount, len) : children;
  return (0, import_jsx_runtime.jsxs)(Root$z, { "data-ui": "AvatarStack", ...restProps, ref, $size: size22, children: [
    len === 0 && (0, import_jsx_runtime.jsx)("div", { children: (0, import_jsx_runtime.jsx)(AvatarCounter, { count: len, size: size22 }) }),
    len !== 0 && extraCount > 1 && (0, import_jsx_runtime.jsx)("div", { children: (0, import_jsx_runtime.jsx)(AvatarCounter, { count: extraCount, size: size22 }) }),
    visibleChildren.map((child, childIndex) => (0, import_jsx_runtime.jsx)("div", { children: (0, import_react48.cloneElement)(child, {
      size: size22
    }) }, String(childIndex)))
  ] });
});
AvatarStack.displayName = "ForwardRef(AvatarStack)";
var Root$y = dt.div(boxStyle, flexItemStyle, responsiveBoxStyle, responsiveGridItemStyle, responsiveMarginStyle, responsivePaddingStyle);
var Box = (0, import_react48.forwardRef)(function(props, ref) {
  const $2 = (0, import_react_compiler_runtime.c)(59);
  let t0, t1, t2, t3, column2, columnStart, columnEnd, flex, height, marginX, marginY, marginTop, marginRight, marginBottom, marginLeft, overflow, paddingX, paddingY, paddingTop, paddingRight, paddingBottom, paddingLeft, row, rowStart, rowEnd, sizing, restProps;
  $2[0] !== props ? ({
    as: t0,
    column: column2,
    columnStart,
    ...
    sizing,
    ...restProps
  } = props, $2[0] = props, $2[1] = t0, $2[2] = t1, $2[3] = t2, $2[4] = t3, $2[5] = column2, $2[6] = columnStart, $2[7] = columnEnd, $2[8] = flex, $2[9] = height, $2[10] = marginX, $2[11] = marginY, $2[12] = marginTop, $2[13] = marginRight, $2[14] = marginBottom, $2[15] = marginLeft, $2[16] = overflow, $2[17] = paddingX, $2[18] = paddingY, $2[19] = paddingTop, $2[20] = paddingRight, $2[21] = paddingBottom, $2[22] = paddingLeft, $2[23] = row, $2[24] = rowStart, $2[25] = rowEnd, $2[26] = sizing, $2[27] = restProps) : (t0 = $2[1], t1 = $2[2], t2 = $2[3], t3 = $2[4], column2 = $2[5], columnStart = $2[6], columnEnd = $2[7], flex = $2[8], height = $2[9], marginX = $2[10], marginY = $2[11], marginTop = $2[12], marginRight = $2[13], marginBottom = $2[14], marginLeft = $2[15], overflow = $2[16], paddingX = $2[17], paddingY = $2[18], paddingTop = $2[19], paddingRight = $2[20], paddingBottom = $2[21], paddingLeft = $2[22], row = $2[23], rowStart = $2[24], rowEnd = $2[25], sizing = $2[26], restProps = $2[27]);
  ...
  let t30;
  return $2[28] !== t4 || $2[29] !== restProps || $2[30] !== t5 || $2[31] !== t6 || $2[32] !== t7 || $2[33] !== t8 || $2[34] !== t9 || $2[35] !== t10 || $2[36] !== t11 || $2[37] !== t12 || $2[38] !== t13 || $2[39] !== t14 || $2[40] !== t15 || $2[41] !== t16 || $2[42] !== t17 || $2[43] !== t18 || $2[44] !== t19 || $2[45] !== t20 || $2[46] !== t21 || $2[47] !== t22 || $2[48] !== t23 || $2[49] !== t24 || $2[50] !== t25 || $2[51] !== t26 || $2[52] !== t27 || $2[53] !== t28 || $2[54] !== t29 || $2[55] !== asProp || $2[56] !== ref || $2[57] !== props.children ? (t30 = (0, import_jsx_runtime.jsx)(Root$y, { "data-as": t4, "data-ui": "Box", ...restProps, $column: t5, $columnStart: t6, $columnEnd: t7, $display: t8, $flex: t9, $height: t10, $margin: t11, $marginX: t12, $marginY: t13, $marginTop: t14, $marginRight: t15, $marginBottom: t16, $marginLeft: t17, $overflow: t18, $padding: t19, $paddingX: t20, $paddingY: t21, $paddingTop: t22, $paddingRight: t23, $paddingBottom: t24, $paddingLeft: t25, $row: t26, $rowStart: t27, $rowEnd: t28, $sizing: t29, as: asProp, ref, children: props.children }), $2[28] = t4, $2[29] = restProps, $2[30] = t5, $2[31] = t6, $2[32] = t7, $2[33] = t8, $2[34] = t9, $2[35] = t10, $2[36] = t11, $2[37] = t12, $2[38] = t13, $2[39] = t14, $2[40] = t15, $2[41] = t16, $2[42] = t17, $2[43] = t18, $2[44] = t19, $2[45] = t20, $2[46] = t21, $2[47] = t22, $2[48] = t23, $2[49] = t24, $2[50] = t25, $2[51] = t26, $2[52] = t27, $2[53] = t28, $2[54] = t29, $2[55] = asProp, $2[56] = ref, $2[57] = props.children, $2[58] = t30) : t30 = $2[58], t30;
});
...
var Root$x = dt.div(responsiveTextFont, responsiveTextAlignStyle, textBaseStyle);
var SpanWithTextOverflow$1 = dt.span`
  ...
  overflow: clip;
`;
var Text = (0, import_react48.forwardRef)(function(props, ref) {
  const $2 = (0, import_react_compiler_runtime.c)(22);
  ...
  $2[0] !== props ? ({
    ...
    weight,
    ...restProps
  } = props, $2[0] = props, $2[1] = t0, $2[2] = t1, $2[3] = t2, $2[4] = childrenProp, $2[5] = textOverflow, $2[6] = align, $2[7] = restProps, $2[8] = weight) : (t0 = $2[1], t1 = $2[2], t2 = $2[3], childrenProp = $2[4], textOverflow = $2[5], align = $2[6], restProps = $2[7], weight = $2[8]);
  const accent = t0 === void 0 ? false : t0, muted = t1 === void 0 ? false : t1, size22 = t2 === void 0 ? 2 : t2;
  let children = childrenProp;
  if (textOverflow === "ellipsis") {
    let t32;
    $2[9] !== children ? (t32 = (0, import_jsx_runtime.jsx)(SpanWithTextOverflow$1, { children }), $2[9] = children, $2[10] = t32) : t32 = $2[10], children = t32;
  }
  const t3 = useArrayProp(align), t4 = useArrayProp(size22);
  let t5;
  $2[11] !== children ? (t5 = (0, import_jsx_runtime.jsx)("span", { children }), $2[11] = children, $2[12] = t5) : t5 = $2[12];
  let t6;
  return $2[13] !== restProps || $2[14] !== accent || $2[15] !== t3 || $2[16] !== muted || $2[17] !== ref || $2[18] !== t4 || $2[19] !== weight || $2[20] !== t5 ? (t6 = (0, import_jsx_runtime.jsx)(Root$x, { "data-ui": "Text", ...restProps, $accent: accent, $align: t3, $muted: muted, ref, $size: t4, $weight: weight, children: t5 }), $2[13] = restProps, $2[14] = accent, $2[15] = t3, $2[16] = muted, $2[17] = ref, $2[18] = t4, $2[19] = weight, $2[20] = t5, $2[21] = t6) : t6 = $2[21], t6;
});
...
var Root$w = dt(Box)(responsiveRadiusStyle, badgeStyle);
var Badge = (0, import_react48.forwardRef)(function(props, ref) {
  ...
  if ($2[0] !== props) {
    ...
    children = t42, t0 = t52, t1 = t62, t2 = t72, t3 = t8, restProps = t9, $2[0] = props, $2[1] = t0, $2[2] = t1, $2[3] = t2, $2[4] = t3, $2[5] = children, $2[6] = restProps;
  } else
    t0 = $2[1], t1 = $2[2], t2 = $2[3], t3 = $2[4], children = $2[5], restProps = $2[6];
  ...
  let t6;
  $2[7] !== fontSize2 || $2[8] !== children ? (t6 = (0, import_jsx_runtime.jsx)(Text, { size: fontSize2, children }), $2[7] = fontSize2, $2[8] = children, $2[9] = t6) : t6 = $2[9];
  let t7;
  return $2[10] !== restProps || $2[11] !== tone || $2[12] !== t4 || $2[13] !== t5 || $2[14] !== ref || $2[15] !== t6 ? (t7 = (0, import_jsx_runtime.jsx)(Root$w, { "data-ui": "Badge", ...restProps, $tone: tone, $radius: t4, padding: t5, ref, children: t6 }), $2[10] = restProps, $2[11] = tone, $2[12] = t4, $2[13] = t5, $2[14] = ref, $2[15] = t6, $2[16] = t7) : t7 = $2[16], t7;
});
Badge.displayName = "ForwardRef(Badge)";
var Root$v = dt(Box)(flexItemStyle, responsiveFlexStyle);
var Flex = (0, import_react48.forwardRef)(function(props, ref) {
  const $2 = (0, import_react_compiler_runtime.c)(17);
  let t0, align, gap, justify, wrap2, restProps, as;
  $2[0] !== props ? ({
    align,
    as,
    direction: t0,
    ...
    wrap: wrap2,
    ...restProps
  } = props, $2[0] = props, $2[1] = t0, $2[2] = align, $2[3] = gap, $2[4] = justify, $2[5] = wrap2, $2[6] = restProps, $2[7] = as) : (t0 = $2[1], align = $2[2], gap = $2[3], justify = $2[4], wrap2 = $2[5], restProps = $2[6], as = $2[7]);
  ...
  let t6;
  return $2[8] !== restProps || $2[9] !== t1 || $2[10] !== t2 || $2[11] !== t3 || $2[12] !== t4 || $2[13] !== t5 || $2[14] !== as || $2[15] !== ref ? (t6 = (0, import_jsx_runtime.jsx)(Root$v, { "data-ui": "Flex", ...restProps, $align: t1, $direction: t2, $gap: t3, $justify: t4, $wrap: t5, forwardedAs: as, ref }), $2[8] = restProps, $2[9] = t1, $2[10] = t2, $2[11] = t3, $2[12] = t4, $2[13] = t5, $2[14] = as, $2[15] = ref, $2[16] = t6) : t6 = $2[16], t6;
});
...
`;
var Spinner = (0, import_react48.forwardRef)(function(props, ref) {
  const $2 = (0, import_react_compiler_runtime.c)(4);
  let t0;
  $2[0] === Symbol.for("react.memo_cache_sentinel") ? (t0 = (0, import_jsx_runtime.jsx)(SpinnerIcon, {}), $2[0] = t0) : t0 = $2[0];
  let t1;
  return $2[1] !== props || $2[2] !== ref ? (t1 = (0, import_jsx_runtime.jsx)(Root$u, { "data-ui": "Spinner", ...props, ref, children: t0 }), $2[1] = props, $2[2] = ref, $2[3] = t1) : t1 = $2[3], t1;
});
...
var LoadingBox = dt.div`
  ...
  box-shadow: inherit;
`;
var Button = (0, import_react48.forwardRef)(function(props, ref) {
  const $2 = (0, import_react_compiler_runtime.c)(64);
  ...
  $2[0] !== props ? ({
    ...
    width,
    ...restProps
  } = props, $2[0] = props, $2[1] = t0, $2[2] = t1, $2[3] = t2, $2[4] = t3, $2[5] = t4, $2[6] = t5, $2[7] = t6, $2[8] = t7, $2[9] = t8, $2[10] = paddingXProp, $2[11] = paddingYProp, $2[12] = paddingTopProp, $2[13] = paddingBottomProp, $2[14] = paddingLeftProp, $2[15] = paddingRightProp, $2[16] = loading, $2[17] = disabled, $2[18] = selected, $2[19] = IconComponent, $2[20] = text, $2[21] = IconRightComponent, $2[22] = textAlign, $2[23] = children, $2[24] = restProps, $2[25] = width) : (t0 = $2[1], t1 = $2[2], t2 = $2[3], t3 = $2[4], t4 = $2[5], t5 = $2[6], t6 = $2[7], t7 = $2[8], t8 = $2[9], paddingXProp = $2[10], paddingYProp = $2[11], paddingTopProp = $2[12], paddingBottomProp = $2[13], paddingLeftProp = $2[14], paddingRightProp = $2[15], loading = $2[16], disabled = $2[17], selected = $2[18], IconComponent = $2[19], text = $2[20], IconRightComponent = $2[21], textAlign = $2[22], children = $2[23], restProps = $2[24], width = $2[25]);
  ...
  let t9, t10;
  $2[26] !== padding || $2[27] !== paddingX || $2[28] !== paddingY || $2[29] !== paddingTop || $2[30] !== paddingBottom || $2[31] !== paddingLeft || $2[32] !== paddingRight ? (t10 = {
    padding,
    paddingX,
    paddingY,
    paddingTop,
    ...
    paddingLeft,
    paddingRight
  }, $2[26] = padding, $2[27] = paddingX, $2[28] = paddingY, $2[29] = paddingTop, $2[30] = paddingBottom, $2[31] = paddingLeft, $2[32] = paddingRight, $2[33] = t10) : t10 = $2[33], t9 = t10;
  const boxProps = t9, t11 = !!(loading || disabled), t12 = selected ? "" : void 0, t13 = !!(loading || disabled);
  let t14;
  $2[34] !== loading ? (t14 = !!loading && (0, import_jsx_runtime.jsx)(LoadingBox, { children: (0, import_jsx_runtime.jsx)(Spinner, {}) }), $2[34] = loading, $2[35] = t14) : t14 = $2[35];
  let t15;
  $2[36] !== IconComponent || $2[37] !== text || $2[38] !== IconRightComponent || $2[39] !== fontSize2 || $2[40] !== muted || $2[41] !== textAlign || $2[42] !== button || $2[43] !== justify || $2[44] !== space || $2[45] !== boxProps ? (t15 = (IconComponent || text || IconRightComponent) && (0, import_jsx_runtime.jsx)(Box, { as: "span", ...boxProps, children: (0, import_jsx_runtime.jsxs)(Flex, { as: "span", justify, gap: space, children: [
    IconComponent && (0, import_jsx_runtime.jsxs)(Text, { size: fontSize2, children: [
      (0, import_react48.isValidElement)(IconComponent) && IconComponent,
      (0, import_react_is.isValidElementType)(IconComponent) && (0, import_jsx_runtime.jsx)(IconComponent, {})
    ] }),
    text && (0, import_jsx_runtime.jsx)(Box, { children: (0, import_jsx_runtime.jsx)(Text, { muted, align: textAlign, size: fontSize2, textOverflow: "ellipsis", weight: button.textWeight, children: text }) }),
    IconRightComponent && (0, import_jsx_runtime.jsxs)(Text, { size: fontSize2, children: [
      (0, import_react48.isValidElement)(IconRightComponent) && IconRightComponent,
      (0, import_react_is.isValidElementType)(IconRightComponent) && (0, import_jsx_runtime.jsx)(IconRightComponent, {})
    ] })
  ] }) }), $2[36] = IconComponent, $2[37] = text, $2[38] = IconRightComponent, $2[39] = fontSize2, $2[40] = muted, $2[41] = textAlign, $2[42] = button, $2[43] = justify, $2[44] = space, $2[45] = boxProps, $2[46] = t15) : t15 = $2[46];
  let t16;
  $2[47] !== children || $2[48] !== boxProps ? (t16 = children && (0, import_jsx_runtime.jsx)(Box, { as: "span", ...boxProps, children }), $2[47] = children, $2[48] = boxProps, $2[49] = t16) : t16 = $2[49];
  let t17;
  return $2[50] !== restProps || $2[51] !== mode || $2[52] !== radius || $2[53] !== tone || $2[54] !== t11 || $2[55] !== t12 || $2[56] !== t13 || $2[57] !== ref || $2[58] !== type || $2[59] !== width || $2[60] !== t14 || $2[61] !== t15 || $2[62] !== t16 ? (t17 = (0, import_jsx_runtime.jsxs)(Root$t, { "data-ui": "Button", ...restProps, $mode: mode, $radius: radius, $tone: tone, "data-disabled": t11, "data-selected": t12, disabled: t13, ref, type, $width: width, children: [
    t14,
    t15,
    t16
  ] }), $2[50] = restProps, $2[51] = mode, $2[52] = radius, $2[53] = tone, $2[54] = t11, $2[55] = t12, $2[56] = t13, $2[57] = ref, $2[58] = type, $2[59] = width, $2[60] = t14, $2[61] = t15, $2[62] = t16, $2[63] = t17) : t17 = $2[63], t17;
});
...
var Card = (0, import_react48.forwardRef)(function(props, ref) {
  ...
  $2[0] !== props ? ({
    ...
    tone: t3,
    ...restProps
  } = props, $2[0] = props, $2[1] = t0, $2[2] = t1, $2[3] = t2, $2[4] = t3, $2[5] = asProp, $2[6] = border2, $2[7] = borderTop2, $2[8] = borderRight2, $2[9] = borderBottom2, $2[10] = borderLeft2, $2[11] = shadow, $2[12] = pressed, $2[13] = selected, $2[14] = restProps, $2[15] = muted, $2[16] = scheme) : (t0 = $2[1], t1 = $2[2], t2 = $2[3], t3 = $2[4], asProp = $2[5], border2 = $2[6], borderTop2 = $2[7], borderRight2 = $2[8], borderBottom2 = $2[9], borderLeft2 = $2[10], shadow = $2[11], pressed = $2[12], selected = $2[13], restProps = $2[14], muted = $2[15], scheme = $2[16]);
  ...
  let t16;
  $2[17] !== t4 || $2[18] !== rootTheme.scheme || $2[19] !== tone || $2[20] !== restProps || $2[21] !== t6 || $2[22] !== t7 || $2[23] !== t8 || $2[24] !== t9 || $2[25] !== t10 || $2[26] !== checkered || $2[27] !== focusRing || $2[28] !== muted || $2[29] !== t11 || $2[30] !== t12 || $2[31] !== t13 || $2[32] !== t14 || $2[33] !== t15 || $2[34] !== as || $2[35] !== ref || $2[36] !== selected ? (t16 = (0, import_jsx_runtime.jsx)(Root$s, { "data-as": t4, "data-scheme": t5, "data-ui": "Card", "data-tone": tone, ...restProps, $border: t6, $borderTop: t7, $borderRight: t8, $borderBottom: t9, $borderLeft: t10, $checkered: checkered, $focusRing: focusRing, $muted: muted, $radius: t11, $shadow: t12, $tone: tone, "data-checkered": t13, "data-pressed": t14, "data-selected": t15, forwardedAs: as, ref, selected }), $2[17] = t4, $2[18] = rootTheme.scheme, $2[19] = tone, $2[20] = restProps, $2[21] = t6, $2[22] = t7, $2[23] = t8, $2[24] = t9, $2[25] = t10, $2[26] = checkered, $2[27] = focusRing, $2[28] = muted, $2[29] = t11, $2[30] = t12, $2[31] = t13, $2[32] = t14, $2[33] = t15, $2[34] = as, $2[35] = ref, $2[36] = selected, $2[37] = t16) : t16 = $2[37];
  let t17;
  return $2[38] !== scheme || $2[39] !== tone || $2[40] !== t16 ? (t17 = (0, import_jsx_runtime.jsx)(ThemeColorProvider, { scheme, tone, children: t16 }), $2[38] = scheme, $2[39] = tone, $2[40] = t16, $2[41] = t17) : t17 = $2[41], t17;
});
...
var Checkbox = (0, import_react48.forwardRef)(function(props, forwardedRef) {
  ...
  $2[0] !== props ? ({
    ...
    style,
    ...restProps
  } = props, $2[0] = props, $2[1] = indeterminate, $2[2] = customValidity, $2[3] = disabled, $2[4] = readOnly, $2[5] = restProps, $2[6] = checked, $2[7] = className, $2[8] = style) : (indeterminate = $2[1], customValidity = $2[2], disabled = $2[3], readOnly = $2[4], restProps = $2[5], checked = $2[6], className = $2[7], style = $2[8]);
  const ref = (0, import_react48.useRef)(null);
  let t0;
  $2[9] === Symbol.for("react.memo_cache_sentinel") ? (t0 = () => ref.current, $2[9] = t0) : t0 = $2[9], (0, import_react48.useImperativeHandle)(forwardedRef, t0);
  let t1, t2;
  $2[10] !== indeterminate ? (t1 = () => {
    ref.current && (ref.current.indeterminate = indeterminate || false);
  }, t2 = [indeterminate], $2[10] = indeterminate, $2[11] = t1, $2[12] = t2) : (t1 = $2[11], t2 = $2[12]), (0, import_react48.useEffect)(t1, t2), useCustomValidity(ref, customValidity);
  const t3 = !disabled && readOnly ? "" : void 0, t4 = customValidity ? "" : void 0, t5 = disabled || readOnly;
  let t6;
  $2[13] !== t3 || $2[14] !== t4 || $2[15] !== restProps || $2[16] !== checked || $2[17] !== t5 || $2[18] !== readOnly ? (t6 = (0, import_jsx_runtime.jsx)(Input$5, { "data-read-only": t3, "data-error": t4, ...restProps, checked, disabled: t5, type: "checkbox", readOnly, ref }), $2[13] = t3, $2[14] = t4, $2[15] = restProps, $2[16] = checked, $2[17] = t5, $2[18] = readOnly, $2[19] = t6) : t6 = $2[19];
  let t7;
  $2[20] === Symbol.for("react.memo_cache_sentinel") ? (t7 = (0, import_jsx_runtime.jsxs)("span", { children: [
    (0, import_jsx_runtime.jsx)(CheckmarkIcon, {}),
    (0, import_jsx_runtime.jsx)(RemoveIcon, {})
  ] }), $2[20] = t7) : t7 = $2[20];
  let t8;
  return $2[21] !== className || $2[22] !== style || $2[23] !== t6 ? (t8 = (0, import_jsx_runtime.jsxs)(Root$r, { className, "data-ui": "Checkbox", style, children: [
    t6,
    t7
...
var Code = (0, import_react48.forwardRef)(function(props, ref) {
  const $2 = (0, import_react_compiler_runtime.c)(23);
  ...
  $2[0] !== props ? ({
    ...
    weight,
    ...restProps
  } = props, $2[0] = props, $2[1] = t0, $2[2] = languageProp, $2[3] = children, $2[4] = restProps, $2[5] = weight) : (t0 = $2[1], languageProp = $2[2], children = $2[3], restProps = $2[4], weight = $2[5]);
  const size22 = t0 === void 0 ? 2 : t0, language = typeof languageProp == "string" ? languageProp : void 0;
  let t1;
  $2[6] !== language ? (t1 = language ? import_react_refractor.default.hasLanguage(language) : false, $2[6] = language, $2[7] = t1) : t1 = $2[7];
  const registered = t1, t2 = useArrayProp(size22);
  let t3;
  $2[8] !== language || $2[9] !== registered || $2[10] !== children ? (t3 = !(language && registered) && (0, import_jsx_runtime.jsx)("code", { children }), $2[8] = language, $2[9] = registered, $2[10] = children, $2[11] = t3) : t3 = $2[11];
  let t4;
  $2[12] !== language || $2[13] !== registered || $2[14] !== children ? (t4 = language && registered && (0, import_jsx_runtime.jsx)(import_react_refractor.default, { inline: true, language, value: String(children) }), $2[12] = language, $2[13] = registered, $2[14] = children, $2[15] = t4) : t4 = $2[15];
  let t5;
  return $2[16] !== restProps || $2[17] !== t2 || $2[18] !== weight || $2[19] !== ref || $2[20] !== t3 || $2[21] !== t4 ? (t5 = (0, import_jsx_runtime.jsxs)(Root$q, { "data-ui": "Code", ...restProps, $size: t2, $weight: weight, ref, children: [
    t3,
    t4
  ] }), $2[16] = restProps, $2[17] = t2, $2[18] = weight, $2[19] = ref, $2[20] = t3, $2[21] = t4, $2[22] = t5) : t5 = $2[22], t5;
});
...
var Root$p = dt(Box)(containerBaseStyle, responsiveContainerWidthStyle);
var Container = (0, import_react48.forwardRef)(function(props, ref) {
  ...
  $2[0] !== props ? ({
    ...
    width: t0,
    ...restProps
  } = props, $2[0] = props, $2[1] = t0, $2[2] = restProps, $2[3] = as) : (t0 = $2[1], restProps = $2[2], as = $2[3]);
  const t1 = useArrayProp(t0 === void 0 ? 2 : t0);
  let t2;
  return $2[4] !== restProps || $2[5] !== t1 || $2[6] !== as || $2[7] !== ref ? (t2 = (0, import_jsx_runtime.jsx)(Root$p, { "data-ui": "Container", ...restProps, $width: t1, forwardedAs: as, ref }), $2[4] = restProps, $2[5] = t1, $2[6] = as, $2[7] = ref, $2[8] = t2) : t2 = $2[8], t2;
});
Container.displayName = "ForwardRef(Container)";
var Root$o = dt(Box)(responsiveGridStyle);
var Grid = (0, import_react48.forwardRef)(function(props, ref) {
  ...
  $2[0] !== props ? ({
    ...
    children,
    ...restProps
  } = props, $2[0] = props, $2[1] = as, $2[2] = autoRows, $2[3] = autoCols, $2[4] = autoFlow, $2[5] = columns, $2[6] = gap, $2[7] = gapX, $2[8] = gapY, $2[9] = rows, $2[10] = restProps, $2[11] = children) : (as = $2[1], autoRows = $2[2], autoCols = $2[3], autoFlow = $2[4], columns = $2[5], gap = $2[6], gapX = $2[7], gapY = $2[8], rows = $2[9], restProps = $2[10], children = $2[11]);
  ...
  let t9;
  return $2[12] !== t0 || $2[13] !== restProps || $2[14] !== t1 || $2[15] !== t2 || $2[16] !== t3 || $2[17] !== t4 || $2[18] !== t5 || $2[19] !== t6 || $2[20] !== t7 || $2[21] !== t8 || $2[22] !== as || $2[23] !== ref || $2[24] !== children ? (t9 = (0, import_jsx_runtime.jsx)(Root$o, { "data-as": t0, "data-ui": "Grid", ...restProps, $autoRows: t1, $autoCols: t2, $autoFlow: t3, $columns: t4, $gap: t5, $gapX: t6, $gapY: t7, $rows: t8, forwardedAs: as, ref, children }), $2[12] = t0, $2[13] = restProps, $2[14] = t1, $2[15] = t2, $2[16] = t3, $2[17] = t4, $2[18] = t5, $2[19] = t6, $2[20] = t7, $2[21] = t8, $2[22] = as, $2[23] = ref, $2[24] = children, $2[25] = t9) : t9 = $2[25], t9;
});
...
var SpanWithTextOverflow = dt.span`
  ...
  overflow: clip;
`;
var Heading = (0, import_react48.forwardRef)(function(props, ref) {
  const $2 = (0, import_react_compiler_runtime.c)(22);
  let t0, t1, t2, childrenProp, textOverflow, align, restProps, weight;
  $2[0] !== props ? ({
    accent: t0,
  ...
  if (textOverflow === "ellipsis") {
    let t32;
    $2[9] !== children ? (t32 = (0, import_jsx_runtime.jsx)(SpanWithTextOverflow, { children }), $2[9] = children, $2[10] = t32) : t32 = $2[10], children = t32;
  }
  const t3 = useArrayProp(align), t4 = useArrayProp(size22);
  let t5;
  $2[11] !== children ? (t5 = (0, import_jsx_runtime.jsx)("span", { children }), $2[11] = children, $2[12] = t5) : t5 = $2[12];
  let t6;
  return $2[13] !== restProps || $2[14] !== accent || $2[15] !== t3 || $2[16] !== muted || $2[17] !== t4 || $2[18] !== weight || $2[19] !== ref || $2[20] !== t5 ? (t6 = (0, import_jsx_runtime.jsx)(Root$n, { "data-ui": "Heading", ...restProps, $accent: accent, $align: t3, $muted: muted, $size: t4, $weight: weight, ref, children: t5 }), $2[13] = restProps, $2[14] = accent, $2[15] = t3, $2[16] = muted, $2[17] = t4, $2[18] = weight, $2[19] = ref, $2[20] = t5, $2[21] = t6) : t6 = $2[21], t6;
});
...
var Inline = (0, import_react48.forwardRef)(function(props, ref) {
  ...
  $2[0] !== props ? ({
    ...
    space,
    ...restProps
  } = props, $2[0] = props, $2[1] = childrenProp, $2[2] = space, $2[3] = restProps, $2[4] = as) : (childrenProp = $2[1], space = $2[2], restProps = $2[3], as = $2[4]);
  let t0, t1;
  if ($2[5] !== childrenProp) {
    let t22;
    $2[7] === Symbol.for("react.memo_cache_sentinel") ? (t22 = (child) => child && (0, import_jsx_runtime.jsx)("div", { children: child }), $2[7] = t22) : t22 = $2[7], t1 = import_react48.Children.map(childrenProp, t22), $2[5] = childrenProp, $2[6] = t1;
  } else
    t1 = $2[6];
  t0 = t1;
  const children = t0, t2 = useArrayProp(space);
  let t3;
  return $2[8] !== restProps || $2[9] !== t2 || $2[10] !== as || $2[11] !== children ? (t3 = (0, import_jsx_runtime.jsx)(Root$m, { "data-ui": "Inline", ...restProps, $space: t2, forwardedAs: as, ref, children }), $2[8] = restProps, $2[9] = t2, $2[10] = as, $2[11] = children, $2[12] = t3) : t3 = $2[12], t3;
});
...
var KBD = (0, import_react48.forwardRef)(function(props, ref) {
  const $2 = (0, import_react_compiler_runtime.c)(17);
  ...
  $2[0] !== props ? ({
    ...
    radius: t2,
    ...restProps
  } = props, $2[0] = props, $2[1] = t0, $2[2] = t1, $2[3] = t2, $2[4] = children, $2[5] = restProps) : (t0 = $2[1], t1 = $2[2], t2 = $2[3], children = $2[4], restProps = $2[5]);
  const fontSize2 = t0 === void 0 ? 0 : t0, padding = t1 === void 0 ? 1 : t1, t3 = useArrayProp(t2 === void 0 ? 2 : t2);
  let t4;
  $2[6] !== fontSize2 || $2[7] !== children ? (t4 = (0, import_jsx_runtime.jsx)(Text, { as: "span", size: fontSize2, weight: "semibold", children }), $2[6] = fontSize2, $2[7] = children, $2[8] = t4) : t4 = $2[8];
  let t5;
  $2[9] !== padding || $2[10] !== t4 ? (t5 = (0, import_jsx_runtime.jsx)(Box, { as: "span", padding, children: t4 }), $2[9] = padding, $2[10] = t4, $2[11] = t5) : t5 = $2[11];
  let t6;
  return $2[12] !== restProps || $2[13] !== t3 || $2[14] !== ref || $2[15] !== t5 ? (t6 = (0, import_jsx_runtime.jsx)(Root$l, { "data-ui": "KBD", ...restProps, $radius: t3, ref, children: t5 }), $2[12] = restProps, $2[13] = t3, $2[14] = ref, $2[15] = t5, $2[16] = t6) : t6 = $2[16], t6;
});
...
`;
var Arrow = (0, import_react48.forwardRef)(function(props, ref) {
  const $2 = (0, import_react_compiler_runtime.c)(24);
  let t0, w2, h, restProps;
  $2[0] !== props ? ({
    width: w2,
    height: h,
    radius: t0,
    ...restProps
  } = props, $2[0] = props, $2[1] = t0, $2[2] = w2, $2[3] = h, $2[4] = restProps) : (t0 = $2[1], w2 = $2[2], h = $2[3], restProps = $2[4]);
  ...
  let t2;
  $2[5] !== strokeWidth || $2[6] !== w2 ? (t2 = (0, import_jsx_runtime.jsx)("mask", { id: "stroke-mask", children: (0, import_jsx_runtime.jsx)("rect", { x: 0, y: strokeWidth, width: w2, height: w2, fill: "white" }) }), $2[5] = strokeWidth, $2[6] = w2, $2[7] = t2) : t2 = $2[7];
  const t3 = strokeWidth * 2;
  let t4;
  $2[8] !== strokePath || $2[9] !== t3 ? (t4 = (0, import_jsx_runtime.jsx)(StrokePath, { d: strokePath, mask: "url(#stroke-mask)", strokeWidth: t3 }), $2[8] = strokePath, $2[9] = t3, $2[10] = t4) : t4 = $2[10];
  let t5;
  $2[11] !== fillPath ? (t5 = (0, import_jsx_runtime.jsx)(ShapePath, { d: fillPath }), $2[11] = fillPath, $2[12] = t5) : t5 = $2[12];
  let t6;
  $2[13] !== w2 || $2[14] !== t1 || $2[15] !== t2 || $2[16] !== t4 || $2[17] !== t5 ? (t6 = (0, import_jsx_runtime.jsxs)("svg", { width: w2, height: w2, viewBox: t1, children: [
    t2,
    t4,
    t5
  ] }), $2[13] = w2, $2[14] = t1, $2[15] = t2, $2[16] = t4, $2[17] = t5, $2[18] = t6) : t6 = $2[18];
  let t7;
  return $2[19] !== restProps || $2[20] !== w2 || $2[21] !== ref || $2[22] !== t6 ? (t7 = (0, import_jsx_runtime.jsx)(Root$k, { ...restProps, $w: w2, ref, children: t6 }), $2[19] = restProps, $2[20] = w2, $2[21] = ref, $2[22] = t6, $2[23] = t7) : t7 = $2[23], t7;
});
...
function BoundaryElementProvider(props) {
  ...
  const value = t0;
  let t2;
  return $2[2] !== value || $2[3] !== children ? (t2 = (0, import_jsx_runtime.jsx)(BoundaryElementContext.Provider, { value, children }), $2[2] = value, $2[3] = children, $2[4] = t2) : t2 = $2[4], t2;
}
...
function useBoundaryElement() {
  const value = (0, import_react48.useContext)(BoundaryElementContext);
...
var ElementQuery = (0, import_react48.forwardRef)(function(props, forwardedRef) {
  const theme = useTheme_v2(), {
    children,
    media = theme.media,
    ...restProps
  } = props, ref = (0, import_react48.useRef)(null), [element, setElement] = (0, import_react48.useState)(null), elementSize = useElementSize(element), width = (0, import_react48.useMemo)(() => (elementSize == null ? void 0 : elementSize.border.width) ?? window.innerWidth, [elementSize]), max2 = (0, import_react48.useMemo)(() => findMaxBreakpoints(media, width), [media, width]), min2 = (0, import_react48.useMemo)(() => findMinBreakpoints(media, width), [media, width]);
  (0, import_react48.useImperativeHandle)(forwardedRef, () => ref.current);
  const setRef = (0, import_react48.useCallback)((el) => {
    ref.current = el, setElement(el);
  }, []);
  return (0, import_jsx_runtime.jsx)("div", { "data-ui": "ElementQuery", ...restProps, "data-eq-max": max2.length ? max2.join(" ") : void 0, "data-eq-min": min2.length ? min2.join(" ") : void 0, ref: setRef, children });
});
ElementQuery.displayName = "ForwardRef(ElementQuery)";
var ErrorBoundary = class extends import_react48.Component {
  constructor() {
    super(...arguments);
  ...
  render() {
    ...
    if (error) {
      ...
      return (0, import_jsx_runtime.jsx)(Code, { children: message });
    }
    return this.props.children;
  }
};
...
function useLayer() {
  const $2 = (0, import_react_compiler_runtime.c)(2), value = (0, import_react48.useContext)(LayerContext);
  if (!value)
...
function LayerProvider(props) {
  const {
  ...
  } = props, parentContextValue = (0, import_react48.useContext)(LayerContext), parent = parentContextValue && getLayerContext(parentContextValue), parentRegisterChild = parent == null ? void 0 : parent.registerChild, level = ((parent == null ? void 0 : parent.level) ?? 0) + 1, zOffset = useArrayProp(zOffsetProp), maxMediaIndex = zOffset.length - 1, mediaIndex = Math.min(useMediaIndex(), maxMediaIndex), zIndex = parent ? parent.zIndex + zOffset[mediaIndex] : zOffset[mediaIndex], [, setChildLayers] = (0, import_react48.useState)({}), [size22, setSize] = (0, import_react48.useState)(0), isTopLayer2 = size22 === 0, registerChild = (0, import_react48.useCallback)((childLevel) => {
    ...
    return childLevel !== void 0 ? setChildLayers((state) => {
      ...
      }) : setSize((v_0) => v_0 - 1), parentDispose == null ? void 0 : parentDispose();
    };
  }, [parentRegisterChild]);
  (0, import_react48.useEffect)(() => parentRegisterChild == null ? void 0 : parentRegisterChild(level), [level, parentRegisterChild]);
  ...
  return (0, import_jsx_runtime.jsx)(LayerContext.Provider, { value, children });
}
LayerProvider.displayName = "LayerProvider";
var Root$j = dt.div({
  position: "relative"
});
var LayerChildren = (0, import_react48.forwardRef)(function(props, forwardedRef) {
  const $2 = (0, import_react_compiler_runtime.c)(22);
  ...
  $2[0] !== props ? ({
    ...
    style: t0,
    ...restProps
  } = props, $2[0] = props, $2[1] = t0, $2[2] = onActivate, $2[3] = onFocus, $2[4] = restProps, $2[5] = children) : (t0 = $2[1], onActivate = $2[2], onFocus = $2[3], restProps = $2[4], children = $2[5]);
  const style = t0 === void 0 ? EMPTY_RECORD : t0, {
    zIndex,
    isTopLayer: isTopLayer2
  } = useLayer(), lastFocusedRef = (0, import_react48.useRef)(null), ref = (0, import_react48.useRef)(null), isTopLayerRef = (0, import_react48.useRef)(isTopLayer2);
  let t1;
  $2[6] === Symbol.for("react.memo_cache_sentinel") ? (t1 = () => ref.current, $2[6] = t1) : t1 = $2[6], (0, import_react48.useImperativeHandle)(forwardedRef, t1);
  let t2, t3;
  ...
  }, t3 = [isTopLayer2, onActivate], $2[7] = isTopLayer2, $2[8] = onActivate, $2[9] = t2, $2[10] = t3) : (t2 = $2[9], t3 = $2[10]), (0, import_react48.useEffect)(t2, t3);
  let t4;
  $2[11] !== onFocus || $2[12] !== isTopLayer2 ? (t4 = (event) => {
  ...
  }, $2[11] = onFocus, $2[12] = isTopLayer2, $2[13] = t4) : t4 = $2[13];
  ...
  let t6;
  return $2[17] !== restProps || $2[18] !== handleFocus || $2[19] !== t5 || $2[20] !== children ? (t6 = (0, import_jsx_runtime.jsx)(Root$j, { ...restProps, "data-ui": "Layer", onFocus: handleFocus, ref, style: t5, children }), $2[17] = restProps, $2[18] = handleFocus, $2[19] = t5, $2[20] = children, $2[21] = t6) : t6 = $2[21], t6;
});
var Layer = (0, import_react48.forwardRef)(function(props, ref) {
  ...
  $2[0] !== props ? ({
    ...
    zOffset: t0,
    ...restProps
  } = props, $2[0] = props, $2[1] = t0, $2[2] = restProps, $2[3] = children) : (t0 = $2[1], restProps = $2[2], children = $2[3]);
  const zOffset = t0 === void 0 ? 1 : t0;
  let t1;
  $2[4] !== restProps || $2[5] !== ref || $2[6] !== children ? (t1 = (0, import_jsx_runtime.jsx)(LayerChildren, { ...restProps, ref, children }), $2[4] = restProps, $2[5] = ref, $2[6] = children, $2[7] = t1) : t1 = $2[7];
  let t2;
  return $2[8] !== zOffset || $2[9] !== t1 ? (t2 = (0, import_jsx_runtime.jsx)(LayerProvider, { zOffset, children: t1 }), $2[8] = zOffset, $2[9] = t1, $2[10] = t2) : t2 = $2[10], t2;
});
...
function usePortal() {
  const value = (0, import_react48.useContext)(PortalContext);
  if (!value)
...
function PortalProvider(props) {
  ...
  } = props, elements = useUnique(elementsProp), fallbackElement = (0, import_react48.useSyncExternalStore)(emptySubscribe, _temp$3, _temp2$1);
  let t0;
  const t1 = boundaryElement || null, t2 = element || fallbackElement;
  let t3;
  $2[0] !== t1 || $2[1] !== t2 || $2[2] !== elements ? (t3 = {
    version: 0,
    boundaryElement: t1,
    element: t2,
    elements
  }, $2[0] = t1, $2[1] = t2, $2[2] = elements, $2[3] = t3) : t3 = $2[3], t0 = t3;
  const value = t0;
  let t4;
  return $2[4] !== value || $2[5] !== children ? (t4 = (0, import_jsx_runtime.jsx)(PortalContext.Provider, { value, children }), $2[4] = value, $2[5] = children, $2[6] = t4) : t4 = $2[6], t4;
}
function _temp2$1() {
  return null;
}
...
var Root$i = dt.div`
  ...
  overflow: clip;
`;
var SrOnly = (0, import_react48.forwardRef)(function(props, ref) {
  const $2 = (0, import_react_compiler_runtime.c)(4), {
    as,
    children
  } = props;
  let t0;
  return $2[0] !== as || $2[1] !== ref || $2[2] !== children ? (t0 = (0, import_jsx_runtime.jsx)(Root$i, { "aria-hidden": true, as, "data-ui": "SrOnly", ref, children }), $2[0] = as, $2[1] = ref, $2[2] = children, $2[3] = t0) : t0 = $2[3], t0;
});
...
var ItemWrapper = dt.div`
  ...
  right: 0;
`;
var VirtualList = (0, import_react48.forwardRef)(function(props, forwardedRef) {
  ...
  $2[0] !== props ? ({
    ...
    renderItem,
    ...restProps
  } = props, $2[0] = props, $2[1] = t0, $2[2] = t1, $2[3] = t2, $2[4] = renderItem, $2[5] = onChange, $2[6] = getItemKey, $2[7] = restProps) : (t0 = $2[1], t1 = $2[2], t2 = $2[3], renderItem = $2[4], onChange = $2[5], getItemKey = $2[6], restProps = $2[7]);
  const as = t0 === void 0 ? "div" : t0, gap = t1 === void 0 ? 0 : t1;
  let t3;
  $2[8] !== t2 ? (t3 = t2 === void 0 ? [] : t2, $2[8] = t2, $2[9] = t3) : t3 = $2[9];
  const items = t3, {
    space
  } = useTheme_v2(), ref = (0, import_react48.useRef)(null), wrapperRef = (0, import_react48.useRef)(null), [scrollTop, setScrollTop] = (0, import_react48.useState)(0), [scrollHeight, setScrollHeight] = (0, import_react48.useState)(0), [itemHeight, setItemHeight] = (0, import_react48.useState)(-1);
  let t4;
  $2[10] === Symbol.for("react.memo_cache_sentinel") ? (t4 = () => ref.current, $2[10] = t4) : t4 = $2[10], (0, import_react48.useImperativeHandle)(forwardedRef, t4);
  let t5;
  ...
  let t6;
  $2[12] !== renderItem ? (t6 = [renderItem], $2[12] = renderItem, $2[13] = t6) : t6 = $2[13], (0, import_react48.useEffect)(t5, t6);
  let t7, t8;
  ...
  }, t8 = [], $2[14] = t7, $2[15] = t8) : (t7 = $2[14], t8 = $2[15]), (0, import_react48.useEffect)(t7, t8);
  ...
  let t9, t10;
  $2[16] !== onChange || $2[17] !== fromIndex || $2[18] !== space || $2[19] !== gap || $2[20] !== itemHeight || $2[21] !== scrollHeight || $2[22] !== scrollTop || $2[23] !== toIndex ? (t9 = () => {
    onChange && onChange({
      fromIndex,
      gap: space[gap],
      itemHeight,
  ...
  }, t10 = [fromIndex, gap, itemHeight, onChange, scrollHeight, scrollTop, space, toIndex], $2[16] = onChange, $2[17] = fromIndex, $2[18] = space, $2[19] = gap, $2[20] = itemHeight, $2[21] = scrollHeight, $2[22] = scrollTop, $2[23] = toIndex, $2[24] = t9, $2[25] = t10) : (t9 = $2[24], t10 = $2[25]), (0, import_react48.useEffect)(t9, t10);
  let t11;
  bb0: {
    ...
    if (itemHeight === -1) {
      const t123 = items[0];
      let t132;
      $2[26] !== renderItem || $2[27] !== t123 ? (t132 = renderItem(t123), $2[26] = renderItem, $2[27] = t123, $2[28] = t132) : t132 = $2[28];
      let t142;
      $2[29] !== t132 ? (t142 = [(0, import_jsx_runtime.jsx)(ItemWrapper, { children: t132 }, 0)], $2[29] = t132, $2[30] = t142) : t142 = $2[30], t11 = t142;
      break bb0;
    }
    let t122;
    if ($2[31] !== items || $2[32] !== fromIndex || $2[33] !== toIndex || $2[34] !== renderItem || $2[35] !== getItemKey || $2[36] !== itemHeight || $2[37] !== space || $2[38] !== gap) {
      let t132;
      $2[40] !== fromIndex || $2[41] !== renderItem || $2[42] !== getItemKey || $2[43] !== itemHeight || $2[44] !== space || $2[45] !== gap ? (t132 = (item, _itemIndex) => {
      ...
      }, $2[40] = fromIndex, $2[41] = renderItem, $2[42] = getItemKey, $2[43] = itemHeight, $2[44] = space, $2[45] = gap, $2[46] = t132) : t132 = $2[46], t122 = items.slice(fromIndex, toIndex).map(t132), $2[31] = items, $2[32] = fromIndex, $2[33] = toIndex, $2[34] = renderItem, $2[35] = getItemKey, $2[36] = itemHeight, $2[37] = space, $2[38] = gap, $2[39] = t122;
    } else
      t122 = $2[39];
    t11 = t122;
  }
  ...
  let t14;
  $2[49] !== wrapperStyle || $2[50] !== children ? (t14 = (0, import_jsx_runtime.jsx)("div", { ref: wrapperRef, style: wrapperStyle, children }), $2[49] = wrapperStyle, $2[50] = children, $2[51] = t14) : t14 = $2[51];
  let t15;
  return $2[52] !== as || $2[53] !== restProps || $2[54] !== t14 ? (t15 = (0, import_jsx_runtime.jsx)(Root$h, { as, "data-ui": "VirtualList", ...restProps, ref, children: t14 }), $2[52] = as, $2[53] = restProps, $2[54] = t14, $2[55] = t15) : t15 = $2[55], t15;
});
...
`;
var PopoverCard = (0, import_react48.memo)((0, import_react48.forwardRef)(function(props, ref) {
  const $2 = (0, import_react_compiler_runtime.c)(60);
  let marginsProp, xProp, yProp, animate2, originX, originY, strategy, style, width, arrowX, arrowY, restProps, padding, children, overflow, arrow22, arrowRef, placement, radius, scheme, shadow, tone;
  $2[0] !== props ? ({
    ...
    y: yProp,
    ...restProps
  } = props, $2[0] = props, $2[1] = marginsProp, $2[2] = xProp, $2[3] = yProp, $2[4] = animate2, $2[5] = originX, $2[6] = originY, $2[7] = strategy, $2[8] = style, $2[9] = width, $2[10] = arrowX, $2[11] = arrowY, $2[12] = restProps, $2[13] = padding, $2[14] = children, $2[15] = overflow, $2[16] = arrow22, $2[17] = arrowRef, $2[18] = placement, $2[19] = radius, $2[20] = scheme, $2[21] = shadow, $2[22] = tone) : (marginsProp = $2[1], xProp = $2[2], yProp = $2[3], animate2 = $2[4], originX = $2[5], originY = $2[6], strategy = $2[7], style = $2[8], width = $2[9], arrowX = $2[10], arrowY = $2[11], restProps = $2[12], padding = $2[13], children = $2[14], overflow = $2[15], arrow22 = $2[16], arrowRef = $2[17], placement = $2[18], radius = $2[19], scheme = $2[20], shadow = $2[21], tone = $2[22]);
  const {
    zIndex
  } = useLayer();
  let t0;
  ...
  let t3;
  $2[23] !== x2 || $2[24] !== originX || $2[25] !== originY || $2[26] !== strategy || $2[27] !== y2 || $2[28] !== width || $2[29] !== zIndex || $2[30] !== t2 || $2[31] !== style ? (t3 = {
    left: x2,
    originX,
    originY,
    position: strategy,
    ...
    willChange: t2,
    ...style
  }, $2[23] = x2, $2[24] = originX, $2[25] = originY, $2[26] = strategy, $2[27] = y2, $2[28] = width, $2[29] = zIndex, $2[30] = t2, $2[31] = style, $2[32] = t3) : t3 = $2[32], t1 = t3;
  const rootStyle2 = t1;
  let t4;
  ...
  let t10;
  $2[38] !== padding || $2[39] !== children ? (t10 = (0, import_jsx_runtime.jsx)(Flex, { direction: "column", flex: 1, padding, children }), $2[38] = padding, $2[39] = children, $2[40] = t10) : t10 = $2[40];
  let t11;
  $2[41] !== overflow || $2[42] !== t10 ? (t11 = (0, import_jsx_runtime.jsx)(Flex, { "data-ui": "Popover__wrapper", direction: "column", flex: 1, overflow, children: t10 }), $2[41] = overflow, $2[42] = t10, $2[43] = t11) : t11 = $2[43];
  let t12;
  $2[44] !== arrow22 || $2[45] !== arrowRef || $2[46] !== arrowStyle ? (t12 = arrow22 && (0, import_jsx_runtime.jsx)(Arrow, { ref: arrowRef, style: arrowStyle, width: DEFAULT_POPOVER_ARROW_WIDTH, height: DEFAULT_POPOVER_ARROW_HEIGHT, radius: DEFAULT_POPOVER_ARROW_RADIUS }), $2[44] = arrow22, $2[45] = arrowRef, $2[46] = arrowStyle, $2[47] = t12) : t12 = $2[47];
  let t13;
  return $2[48] !== t8 || $2[49] !== placement || $2[50] !== radius || $2[51] !== ref || $2[52] !== scheme || $2[53] !== shadow || $2[54] !== rootStyle2 || $2[55] !== tone || $2[56] !== t9 || $2[57] !== t11 || $2[58] !== t12 ? (t13 = (0, import_jsx_runtime.jsxs)(MotionCard$1, { "data-ui": "Popover", ...t8, "data-placement": placement, radius, ref, scheme, shadow, sizing: "border", style: rootStyle2, tone, ...t9, children: [
    t11,
    t12
  ] }), $2[48] = t8, $2[49] = placement, $2[50] = radius, $2[51] = ref, $2[52] = scheme, $2[53] = shadow, $2[54] = rootStyle2, $2[55] = tone, $2[56] = t9, $2[57] = t11, $2[58] = t12, $2[59] = t13) : t13 = $2[59], t13;
}));
PopoverCard.displayName = "Memo(ForwardRef(PopoverCard))";
var Popover = (0, import_react48.memo)((0, import_react48.forwardRef)(function(props, forwardedRef) {
  var _a, _b, _c, _d, _e2, _f;
  const {
    container,
    layer
  ...
  }), widthRef = (0, import_react48.useRef)(width);
  ...
  const maxWidth = calcMaxWidth({
    boundaryWidth,
    currentWidth: width
  }), maxWidthRef = (0, import_react48.useRef)(maxWidth);
  (0, import_react48.useEffect)(() => {
    maxWidthRef.current = maxWidth;
  }, [maxWidth]);
  const referenceWidthRef = (0, import_react48.useRef)();
  (0, import_react48.useEffect)(() => {
  ...
  const middleware2 = (0, import_react48.useMemo)(() => {
    const ret = [];
    ...
    })), (constrainSize || matchReferenceWidth) && ret.push(size3({
      apply({
        availableWidth,
        availableHeight,
        elements,
  ...
  }, [childProp, refs]), child = (0, import_react48.useMemo)(() => !childProp || referenceElement ? null : (0, import_react48.cloneElement)(childProp, {
    ref: setReference
  }), [childProp, referenceElement, setReference]);
  if ((0, import_react48.useEffect)(() => {
    updateRef && (typeof updateRef == "function" ? updateRef(update) : updateRef && (updateRef.current = update));
  }, [update, updateRef]), (0, import_react48.useEffect)(() => {
  ...
  const popover = (0, import_jsx_runtime.jsx)(LayerProvider, { zOffset, children: (0, import_jsx_runtime.jsx)(PopoverCard, { ...restProps, __unstable_margins: margins, animate: animate2, arrow: arrowProp, arrowRef: setArrow, arrowX, arrowY, hidden: referenceHidden, overflow, padding, placement, radius, ref: setFloating, scheme, shadow, originX, originY, strategy, tone, width: matchReferenceWidth ? referenceWidthRef.current : width, x: x2, y: y2, children: content }) }), children = open && (portal ? (0, import_jsx_runtime.jsx)(Portal, { __unstable_name: typeof portal == "string" ? portal : void 0, children: popover }) : popover);
  return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    animate2 ? (0, import_jsx_runtime.jsx)(AnimatePresence, { children }) : children,
    child
  ] });
}));
...
var Radio = (0, import_react48.forwardRef)(function(props, forwardedRef) {
  ...
  $2[0] !== props ? ({
    ...
    readOnly,
    ...restProps
  } = props, $2[0] = props, $2[1] = customValidity, $2[2] = disabled, $2[3] = readOnly, $2[4] = restProps, $2[5] = className, $2[6] = style) : (customValidity = $2[1], disabled = $2[2], readOnly = $2[3], restProps = $2[4], className = $2[5], style = $2[6]);
  const ref = (0, import_react48.useRef)(null);
  let t0;
  $2[7] === Symbol.for("react.memo_cache_sentinel") ? (t0 = () => ref.current, $2[7] = t0) : t0 = $2[7], (0, import_react48.useImperativeHandle)(forwardedRef, t0), useCustomValidity(ref, customValidity);
  const t1 = !disabled && readOnly ? "" : void 0, t2 = customValidity ? "" : void 0, t3 = disabled || readOnly;
  let t4;
  $2[8] !== t1 || $2[9] !== t2 || $2[10] !== restProps || $2[11] !== t3 || $2[12] !== readOnly ? (t4 = (0, import_jsx_runtime.jsx)(Input$4, { "data-read-only": t1, "data-error": t2, ...restProps, disabled: t3, readOnly, ref, type: "radio" }), $2[8] = t1, $2[9] = t2, $2[10] = restProps, $2[11] = t3, $2[12] = readOnly, $2[13] = t4) : t4 = $2[13];
  let t5;
  $2[14] === Symbol.for("react.memo_cache_sentinel") ? (t5 = (0, import_jsx_runtime.jsx)("span", {}), $2[14] = t5) : t5 = $2[14];
  let t6;
  return $2[15] !== className || $2[16] !== style || $2[17] !== t4 ? (t6 = (0, import_jsx_runtime.jsxs)(Root$g, { className, "data-ui": "Radio", style, children: [
    t4,
    t5
...
var Select = (0, import_react48.forwardRef)(function(props, forwardedRef) {
  ...
  $2[0] !== props ? ({
    ...
    space: t3,
    ...restProps
  } = props, $2[0] = props, $2[1] = t0, $2[2] = t1, $2[3] = t2, $2[4] = t3, $2[5] = customValidity, $2[6] = disabled, $2[7] = readOnly, $2[8] = restProps, $2[9] = children) : (t0 = $2[1], t1 = $2[2], t2 = $2[3], t3 = $2[4], customValidity = $2[5], disabled = $2[6], readOnly = $2[7], restProps = $2[8], children = $2[9]);
  const fontSize2 = t0 === void 0 ? 2 : t0, padding = t1 === void 0 ? 3 : t1, radius = t2 === void 0 ? 2 : t2, space = t3 === void 0 ? 3 : t3, ref = (0, import_react48.useRef)(null);
  let t4;
  $2[10] === Symbol.for("react.memo_cache_sentinel") ? (t4 = () => ref.current, $2[10] = t4) : t4 = $2[10], (0, import_react48.useImperativeHandle)(forwardedRef, t4), useCustomValidity(ref, customValidity);
  ...
  let t11;
  $2[11] !== t5 || $2[12] !== restProps || $2[13] !== t6 || $2[14] !== t7 || $2[15] !== t8 || $2[16] !== t9 || $2[17] !== t10 || $2[18] !== children ? (t11 = (0, import_jsx_runtime.jsx)(Input$3, { "data-read-only": t5, "data-ui": "Select", ...restProps, $fontSize: t6, $padding: t7, $radius: t8, $space: t9, disabled: t10, ref, children }), $2[11] = t5, $2[12] = restProps, $2[13] = t6, $2[14] = t7, $2[15] = t8, $2[16] = t9, $2[17] = t10, $2[18] = children, $2[19] = t11) : t11 = $2[19];
  let t12;
  $2[20] === Symbol.for("react.memo_cache_sentinel") ? (t12 = (0, import_jsx_runtime.jsx)(ChevronDownIcon, {}), $2[20] = t12) : t12 = $2[20];
  let t13;
  $2[21] !== fontSize2 ? (t13 = (0, import_jsx_runtime.jsx)(Text, { size: fontSize2, children: t12 }), $2[21] = fontSize2, $2[22] = t13) : t13 = $2[22];
  let t14;
  $2[23] !== padding || $2[24] !== t13 ? (t14 = (0, import_jsx_runtime.jsx)(IconBox, { padding, children: t13 }), $2[23] = padding, $2[24] = t13, $2[25] = t14) : t14 = $2[25];
  let t15;
  return $2[26] !== t11 || $2[27] !== t14 ? (t15 = (0, import_jsx_runtime.jsxs)(Root$f, { "data-ui": "Select", children: [
    t11,
    t14
...
var Stack = (0, import_react48.forwardRef)(function(props, ref) {
  const $2 = (0, import_react_compiler_runtime.c)(10);
  ...
  $2[0] !== props ? ({
    ...
    space,
    ...restProps
  } = props, $2[0] = props, $2[1] = as, $2[2] = space, $2[3] = restProps) : (as = $2[1], space = $2[2], restProps = $2[3]);
  const t0 = typeof as == "string" ? as : void 0, t1 = useArrayProp(space);
  let t2;
  return $2[4] !== t0 || $2[5] !== restProps || $2[6] !== t1 || $2[7] !== as || $2[8] !== ref ? (t2 = (0, import_jsx_runtime.jsx)(Root$e, { "data-as": t0, "data-ui": "Stack", ...restProps, $space: t1, forwardedAs: as, ref }), $2[4] = t0, $2[5] = restProps, $2[6] = t1, $2[7] = as, $2[8] = ref, $2[9] = t2) : t2 = $2[9], t2;
});
...
var Switch = (0, import_react48.forwardRef)(function(props, forwardedRef) {
  const $2 = (0, import_react_compiler_runtime.c)(26);
  ...
  $2[0] !== props ? ({
    ...
    style,
    ...restProps
  } = props, $2[0] = props, $2[1] = indeterminate, $2[2] = disabled, $2[3] = readOnly, $2[4] = checked, $2[5] = restProps, $2[6] = className, $2[7] = style) : (indeterminate = $2[1], disabled = $2[2], readOnly = $2[3], checked = $2[4], restProps = $2[5], className = $2[6], style = $2[7]);
  const ref = (0, import_react48.useRef)(null);
  let t0;
  $2[8] === Symbol.for("react.memo_cache_sentinel") ? (t0 = () => ref.current, $2[8] = t0) : t0 = $2[8], (0, import_react48.useImperativeHandle)(forwardedRef, t0);
  let t1, t2;
  $2[9] !== indeterminate ? (t1 = () => {
    ref.current && (ref.current.indeterminate = indeterminate || false);
  }, t2 = [indeterminate], $2[9] = indeterminate, $2[10] = t1, $2[11] = t2) : (t1 = $2[10], t2 = $2[11]), (0, import_react48.useEffect)(t1, t2);
  const t3 = !disabled && readOnly ? "" : void 0, t4 = indeterminate !== true && checked, t5 = disabled || readOnly;
  let t6;
  $2[12] !== t3 || $2[13] !== restProps || $2[14] !== t4 || $2[15] !== t5 ? (t6 = (0, import_jsx_runtime.jsx)(Input$2, { "data-read-only": t3, ...restProps, checked: t4, disabled: t5, type: "checkbox", ref }), $2[12] = t3, $2[13] = restProps, $2[14] = t4, $2[15] = t5, $2[16] = t6) : t6 = $2[16];
  let t7;
  $2[17] === Symbol.for("react.memo_cache_sentinel") ? (t7 = (0, import_jsx_runtime.jsx)(Track, {}), $2[17] = t7) : t7 = $2[17];
  let t8;
  $2[18] !== checked || $2[19] !== indeterminate ? (t8 = (0, import_jsx_runtime.jsxs)(Representation, { "aria-hidden": true, "data-name": "representation", children: [
    t7,
  ...
  let t9;
  return $2[21] !== className || $2[22] !== style || $2[23] !== t6 || $2[24] !== t8 ? (t9 = (0, import_jsx_runtime.jsxs)(Root$d, { className, "data-ui": "Switch", style, children: [
    t6,
    t8
...
var TextArea = (0, import_react48.forwardRef)(function(props, forwardedRef) {
  const $2 = (0, import_react_compiler_runtime.c)(29);
  ...
  $2[0] !== props ? ({
    ...
    ...restProps
  } = props, $2[0] = props, $2[1] = t0, $2[2] = t1, $2[3] = t2, $2[4] = t3, $2[5] = t4, $2[6] = customValidity, $2[7] = restProps, $2[8] = weight, $2[9] = __unstable_disableFocusRing) : (t0 = $2[1], t1 = $2[2], t2 = $2[3], t3 = $2[4], t4 = $2[5], customValidity = $2[6], restProps = $2[7], weight = $2[8], __unstable_disableFocusRing = $2[9]);
  const border2 = t0 === void 0 ? true : t0, disabled = t1 === void 0 ? false : t1, fontSize2 = t2 === void 0 ? 2 : t2, padding = t3 === void 0 ? 3 : t3, radius = t4 === void 0 ? 2 : t4, ref = (0, import_react48.useRef)(null), rootTheme = useRootTheme();
  let t5;
  $2[10] === Symbol.for("react.memo_cache_sentinel") ? (t5 = () => ref.current, $2[10] = t5) : t5 = $2[10], (0, import_react48.useImperativeHandle)(forwardedRef, t5), useCustomValidity(ref, customValidity);
  ...
  let t12;
  $2[11] !== rootTheme.scheme || $2[12] !== rootTheme.tone || $2[13] !== restProps || $2[14] !== t8 || $2[15] !== t9 || $2[16] !== t11 || $2[17] !== weight || $2[18] !== disabled ? (t12 = (0, import_jsx_runtime.jsx)(Input$1, { "data-as": "textarea", "data-scheme": t6, "data-tone": t7, ...restProps, $fontSize: t8, $padding: t9, $scheme: t10, $space: t11, $tone: rootTheme.tone, $weight: weight, disabled, ref }), $2[11] = rootTheme.scheme, $2[12] = rootTheme.tone, $2[13] = restProps, $2[14] = t8, $2[15] = t9, $2[16] = t11, $2[17] = weight, $2[18] = disabled, $2[19] = t12) : t12 = $2[19];
  const t13 = useArrayProp(radius), t14 = border2 ? "" : void 0;
  let t15;
  $2[20] !== t13 || $2[21] !== __unstable_disableFocusRing || $2[22] !== rootTheme.scheme || $2[23] !== rootTheme.tone || $2[24] !== t14 ? (t15 = (0, import_jsx_runtime.jsx)(Presentation$1, { $radius: t13, $unstableDisableFocusRing: __unstable_disableFocusRing, $scheme: rootTheme.scheme, $tone: rootTheme.tone, "data-border": t14, "data-scheme": rootTheme.scheme, "data-tone": rootTheme.tone }), $2[20] = t13, $2[21] = __unstable_disableFocusRing, $2[22] = rootTheme.scheme, $2[23] = rootTheme.tone, $2[24] = t14, $2[25] = t15) : t15 = $2[25];
  let t16;
  return $2[26] !== t12 || $2[27] !== t15 ? (t16 = (0, import_jsx_runtime.jsx)(Root$c, { "data-ui": "TextArea", children: (0, import_jsx_runtime.jsxs)(InputRoot$1, { children: [
    t12,
    t15
...
var TextInput = (0, import_react48.forwardRef)(function(props, forwardedRef) {
  const $2 = (0, import_react_compiler_runtime.c)(86);
  let t0, t1, t2, t3, t4, t5, t6, clearButton, IconComponent, IconRightComponent, suffix, prefix2, customValidity, onClear, __unstable_disableFocusRing, readOnly, restProps, weight;
  $2[0] !== props ? ({
    __unstable_disableFocusRing,
    border: t0,
    clearButton,
    ...
    weight,
    ...restProps
  } = props, $2[0] = props, $2[1] = t0, $2[2] = t1, $2[3] = t2, $2[4] = t3, $2[5] = t4, $2[6] = t5, $2[7] = t6, $2[8] = clearButton, $2[9] = IconComponent, $2[10] = IconRightComponent, $2[11] = suffix, $2[12] = prefix2, $2[13] = customValidity, $2[14] = onClear, $2[15] = __unstable_disableFocusRing, $2[16] = readOnly, $2[17] = restProps, $2[18] = weight) : (t0 = $2[1], t1 = $2[2], t2 = $2[3], t3 = $2[4], t4 = $2[5], t5 = $2[6], t6 = $2[7], clearButton = $2[8], IconComponent = $2[9], IconRightComponent = $2[10], suffix = $2[11], prefix2 = $2[12], customValidity = $2[13], onClear = $2[14], __unstable_disableFocusRing = $2[15], readOnly = $2[16], restProps = $2[17], weight = $2[18]);
  const border2 = t0 === void 0 ? true : t0, disabled = t1 === void 0 ? false : t1, fontSizeProp = t2 === void 0 ? 2 : t2, paddingProp = t3 === void 0 ? 3 : t3, radiusProp = t4 === void 0 ? 2 : t4, spaceProp = t5 === void 0 ? 3 : t5, type = t6 === void 0 ? "text" : t6, ref = (0, import_react48.useRef)(null), rootTheme = useRootTheme(), fontSize2 = useArrayProp(fontSizeProp), padding = useArrayProp(paddingProp), radius = useArrayProp(radiusProp), space = useArrayProp(spaceProp), $hasClearButton = !!clearButton, $hasIcon = !!IconComponent, $hasIconRight = !!IconRightComponent, $hasSuffix = !!suffix, $hasPrefix = !!prefix2;
  let t7;
  $2[19] === Symbol.for("react.memo_cache_sentinel") ? (t7 = () => ref.current, $2[19] = t7) : t7 = $2[19], (0, import_react48.useImperativeHandle)(forwardedRef, t7), useCustomValidity(ref, customValidity);
  ...
  let t9, t10;
  $2[22] !== prefix2 || $2[23] !== radius ? (t10 = prefix2 && (0, import_jsx_runtime.jsx)(Prefix, { borderTop: true, borderLeft: true, borderBottom: true, radius, sizing: "border", tone: "inherit", children: (0, import_jsx_runtime.jsx)("span", { children: prefix2 }) }), $2[22] = prefix2, $2[23] = radius, $2[24] = t10) : t10 = $2[24], t9 = t10;
  const prefixNode = t9;
  let t11;
  const t12 = border2 ? "" : void 0;
  let t13;
  $2[25] !== IconComponent || $2[26] !== fontSize2 || $2[27] !== padding ? (t13 = IconComponent && (0, import_jsx_runtime.jsx)(LeftBox, { padding, children: (0, import_jsx_runtime.jsxs)(Text, { size: fontSize2, children: [
    (0, import_react48.isValidElement)(IconComponent) && IconComponent,
    (0, import_react_is.isValidElementType)(IconComponent) && (0, import_jsx_runtime.jsx)(IconComponent, {})
  ] }) }), $2[25] = IconComponent, $2[26] = fontSize2, $2[27] = padding, $2[28] = t13) : t13 = $2[28];
  let t14;
  $2[29] !== $hasClearButton || $2[30] !== IconRightComponent || $2[31] !== fontSize2 || $2[32] !== padding ? (t14 = !$hasClearButton && IconRightComponent && (0, import_jsx_runtime.jsx)(RightBox, { padding, children: (0, import_jsx_runtime.jsxs)(Text, { size: fontSize2, children: [
    (0, import_react48.isValidElement)(IconRightComponent) && IconRightComponent,
    (0, import_react_is.isValidElementType)(IconRightComponent) && (0, import_jsx_runtime.jsx)(IconRightComponent, {})
  ] }) }), $2[29] = $hasClearButton, $2[30] = IconRightComponent, $2[31] = fontSize2, $2[32] = padding, $2[33] = t14) : t14 = $2[33];
  let t15;
  $2[34] !== $hasPrefix || $2[35] !== __unstable_disableFocusRing || $2[36] !== $hasSuffix || $2[37] !== radius || $2[38] !== rootTheme.scheme || $2[39] !== rootTheme.tone || $2[40] !== t12 || $2[41] !== t13 || $2[42] !== t14 ? (t15 = (0, import_jsx_runtime.jsxs)(Presentation, { $hasPrefix, $unstableDisableFocusRing: __unstable_disableFocusRing, $hasSuffix, $radius: radius, $scheme: rootTheme.scheme, $tone: rootTheme.tone, "data-border": t12, "data-scheme": rootTheme.scheme, "data-tone": rootTheme.tone, children: [
    t13,
    t14
  ] }), $2[34] = $hasPrefix, $2[35] = __unstable_disableFocusRing, $2[36] = $hasSuffix, $2[37] = radius, $2[38] = rootTheme.scheme, $2[39] = rootTheme.tone, $2[40] = t12, $2[41] = t13, $2[42] = t14, $2[43] = t15) : t15 = $2[43], t11 = t15;
  const presentationNode = t11;
  let t16, t17;
  if ($2[44] !== padding) {
    let t182;
    $2[46] === Symbol.for("react.memo_cache_sentinel") ? (t182 = (v2) => v2 === 0 ? 0 : v2 === 1 || v2 === 2 ? 1 : v2 - 2, $2[46] = t182) : t182 = $2[46], t17 = padding.map(t182), $2[44] = padding, $2[45] = t17;
  } else
    t17 = $2[45];
  t16 = t17;
  ...
  if ($2[47] !== padding) {
    let t202;
    $2[49] === Symbol.for("react.memo_cache_sentinel") ? (t202 = (v_0) => v_0 === 0 || v_0 === 1 ? 0 : v_0 === 2 ? 1 : v_0 - 1, $2[49] = t202) : t202 = $2[49], t19 = padding.map(t202), $2[47] = padding, $2[48] = t19;
  } else
    t19 = $2[48];
  t18 = t19;
  ...
  let t21, t22;
  $2[50] !== disabled || $2[51] !== readOnly || $2[52] !== clearButton || $2[53] !== customValidity || $2[54] !== fontSize2 || $2[55] !== clearButtonPadding || $2[56] !== radius || $2[57] !== clearButtonProps || $2[58] !== handleClearClick || $2[59] !== clearButtonBoxPadding ? (t22 = !disabled && !readOnly && clearButton && (0, import_jsx_runtime.jsx)(RightCard, { forwardedAs: "span", padding: clearButtonBoxPadding, style: CLEAR_BUTTON_BOX_STYLE, tone: customValidity ? "critical" : "inherit", children: (0, import_jsx_runtime.jsx)(TextInputClearButton, { "aria-label": "Clear", "data-qa": "clear-button", fontSize: fontSize2, icon: CloseIcon, mode: "bleed", padding: clearButtonPadding, radius, ...clearButtonProps, onClick: handleClearClick, onMouseDown: handleClearMouseDown }) }), $2[50] = disabled, $2[51] = readOnly, $2[52] = clearButton, $2[53] = customValidity, $2[54] = fontSize2, $2[55] = clearButtonPadding, $2[56] = radius, $2[57] = clearButtonProps, $2[58] = handleClearClick, $2[59] = clearButtonBoxPadding, $2[60] = t22) : t22 = $2[60], t21 = t22;
  const clearButtonNode = t21;
  let t23, t24;
  $2[61] !== suffix || $2[62] !== radius ? (t24 = suffix && (0, import_jsx_runtime.jsx)(Suffix, { borderTop: true, borderRight: true, borderBottom: true, radius, sizing: "border", tone: "inherit", children: (0, import_jsx_runtime.jsx)("span", { children: suffix }) }), $2[61] = suffix, $2[62] = radius, $2[63] = t24) : t24 = $2[63], t23 = t24;
  const suffixNode = t23, t25 = $hasIconRight || $hasClearButton;
  let t26;
  $2[64] !== rootTheme.scheme || $2[65] !== rootTheme.tone || $2[66] !== restProps || $2[67] !== fontSize2 || $2[68] !== $hasIcon || $2[69] !== t25 || $2[70] !== padding || $2[71] !== space || $2[72] !== weight || $2[73] !== disabled || $2[74] !== readOnly || $2[75] !== type ? (t26 = (0, import_jsx_runtime.jsx)(Input, { "data-as": "input", "data-scheme": rootTheme.scheme, "data-tone": rootTheme.tone, ...restProps, $fontSize: fontSize2, $iconLeft: $hasIcon, $iconRight: t25, $padding: padding, $scheme: rootTheme.scheme, $space: space, $tone: rootTheme.tone, $weight: weight, disabled, readOnly, ref, type }), $2[64] = rootTheme.scheme, $2[65] = rootTheme.tone, $2[66] = restProps, $2[67] = fontSize2, $2[68] = $hasIcon, $2[69] = t25, $2[70] = padding, $2[71] = space, $2[72] = weight, $2[73] = disabled, $2[74] = readOnly, $2[75] = type, $2[76] = t26) : t26 = $2[76];
  let t27;
  $2[77] !== t26 || $2[78] !== presentationNode || $2[79] !== clearButtonNode ? (t27 = (0, import_jsx_runtime.jsxs)(InputRoot, { children: [
    t26,
    presentationNode,
    clearButtonNode
  ] }), $2[77] = t26, $2[78] = presentationNode, $2[79] = clearButtonNode, $2[80] = t27) : t27 = $2[80];
  let t28;
  return $2[81] !== rootTheme.tone || $2[82] !== prefixNode || $2[83] !== t27 || $2[84] !== suffixNode ? (t28 = (0, import_jsx_runtime.jsxs)(Root$b, { "data-ui": "TextInput", tone: rootTheme.tone, children: [
    prefixNode,
    t27,
    suffixNode
  ] }), $2[81] = rootTheme.tone, $2[82] = prefixNode, $2[83] = t27, $2[84] = suffixNode, $2[85] = t28) : t28 = $2[85], t28;
});
...
function useDelayedState(initialState) {
  const $2 = (0, import_react_compiler_runtime.c)(3), [state, setState] = (0, import_react48.useState)(initialState), delayedAction = (0, import_react48.useRef)();
  let t0;
...
`;
var TooltipCard = (0, import_react48.memo)((0, import_react48.forwardRef)(function(props, ref) {
  const $2 = (0, import_react_compiler_runtime.c)(42);
  let animate2, originX, originY, style, arrowX, arrowY, restProps, arrow22, arrowRef, placement, padding, radius, scheme, shadow, children;
  $2[0] !== props ? ({
    animate: animate2,
    arrow: arrow22,
    arrowRef,
    ...
    style,
    ...restProps
  } = props, $2[0] = props, $2[1] = animate2, $2[2] = originX, $2[3] = originY, $2[4] = style, $2[5] = arrowX, $2[6] = arrowY, $2[7] = restProps, $2[8] = arrow22, $2[9] = arrowRef, $2[10] = placement, $2[11] = padding, $2[12] = radius, $2[13] = scheme, $2[14] = shadow, $2[15] = children) : (animate2 = $2[1], originX = $2[2], originY = $2[3], style = $2[4], arrowX = $2[5], arrowY = $2[6], restProps = $2[7], arrow22 = $2[8], arrowRef = $2[9], placement = $2[10], padding = $2[11], radius = $2[12], scheme = $2[13], shadow = $2[14], children = $2[15]);
  let t0;
  const t1 = animate2 ? "transform" : void 0;
  let t2;
  $2[16] !== originX || $2[17] !== originY || $2[18] !== t1 || $2[19] !== style ? (t2 = {
    originX,
    originY,
    willChange: t1,
    ...style
  }, $2[16] = originX, $2[17] = originY, $2[18] = t1, $2[19] = style, $2[20] = t2) : t2 = $2[20], t0 = t2;
  const rootStyle2 = t0;
  let t3;
  ...
  let t9;
  $2[26] !== arrow22 || $2[27] !== arrowRef || $2[28] !== arrowStyle ? (t9 = arrow22 && (0, import_jsx_runtime.jsx)(Arrow, { ref: arrowRef, style: arrowStyle, width: DEFAULT_TOOLTIP_ARROW_WIDTH, height: DEFAULT_TOOLTIP_ARROW_HEIGHT, radius: DEFAULT_TOOLTIP_ARROW_RADIUS }), $2[26] = arrow22, $2[27] = arrowRef, $2[28] = arrowStyle, $2[29] = t9) : t9 = $2[29];
  let t10;
  return $2[30] !== t7 || $2[31] !== placement || $2[32] !== padding || $2[33] !== radius || $2[34] !== ref || $2[35] !== scheme || $2[36] !== shadow || $2[37] !== rootStyle2 || $2[38] !== t8 || $2[39] !== children || $2[40] !== t9 ? (t10 = (0, import_jsx_runtime.jsxs)(MotionCard, { "data-ui": "Tooltip__card", ...t7, "data-placement": placement, padding, radius, ref, scheme, shadow, style: rootStyle2, ...t8, children: [
    children,
    t9
  ] }), $2[30] = t7, $2[31] = placement, $2[32] = padding, $2[33] = radius, $2[34] = ref, $2[35] = scheme, $2[36] = shadow, $2[37] = rootStyle2, $2[38] = t8, $2[39] = children, $2[40] = t9, $2[41] = t10) : t10 = $2[41], t10;
}));
TooltipCard.displayName = "Memo(ForwardRef(TooltipCard))";
var TooltipDelayGroupContext = createGlobalScopedContext("@sanity/ui/context/tooltipDelayGroup", null);
function useTooltipDelayGroup() {
  return (0, import_react48.useContext)(TooltipDelayGroupContext);
}
function TooltipDelayGroupProvider(props) {
  ...
  let t2;
  $2[0] !== isGroupActive || $2[1] !== setIsGroupActive || $2[2] !== openTooltipId || $2[3] !== setOpenTooltipId || $2[4] !== t1 || $2[5] !== closeDelay ? (t2 = {
    isGroupActive,
    setIsGroupActive,
    openTooltipId,
    setOpenTooltipId,
    openDelay: t1,
    closeDelay
  }, $2[0] = isGroupActive, $2[1] = setIsGroupActive, $2[2] = openTooltipId, $2[3] = setOpenTooltipId, $2[4] = t1, $2[5] = closeDelay, $2[6] = t2) : t2 = $2[6], t0 = t2;
  const value = t0;
  let t3;
  return $2[7] !== value || $2[8] !== children ? (t3 = (0, import_jsx_runtime.jsx)(TooltipDelayGroupContext.Provider, { value, children }), $2[7] = value, $2[8] = children, $2[9] = t3) : t3 = $2[9], t3;
}
TooltipDelayGroupProvider.displayName = "TooltipDelayGroupProvider";
var Root$a = dt(Layer)`
  pointer-events: none;
`;
var Tooltip = (0, import_react48.forwardRef)(function(props, forwardedRef) {
  var _a, _b, _c, _d, _e2;
  const boundaryElementContext = useBoundaryElement(), {
    ...
    delay: delay2,
    ...restProps
  } = props, animate2 = usePrefersReducedMotion() ? false : _animate, fallbackPlacements = useArrayProp(fallbackPlacementsProp), ref = (0, import_react48.useRef)(null), [referenceElement, setReferenceElement] = (0, import_react48.useState)(null), arrowRef = (0, import_react48.useRef)(null), rootBoundary = "viewport", [tooltipMaxWidth, setTooltipMaxWidth] = (0, import_react48.useState)(0);
  (0, import_react48.useImperativeHandle)(forwardedRef, () => ref.current);
  const portal = usePortal(), portalElement = typeof portalProp == "string" ? ((_a = portal.elements) == null ? void 0 : _a[portalProp]) || null : portal.element, middleware2 = (0, import_react48.useMemo)(() => {
    const ret = [];
  ...
  }, [isInsideGroup, delayGroupContext, openDelay, tooltipId, closeDelay, setIsOpen]), handleBlur = (0, import_react48.useCallback)((e) => {
    var _a2, _b2;
    handleIsOpenChange(false), (_b2 = (_a2 = childProp == null ? void 0 : childProp.props) == null ? void 0 : _a2.onBlur) == null ? void 0 : _b2.call(_a2, e);
  }, [childProp == null ? void 0 : childProp.props, handleIsOpenChange]), handleClick = (0, import_react48.useCallback)((e_0) => {
    var _a2, _b2;
    handleIsOpenChange(false, true), (_b2 = childProp == null ? void 0 : (_a2 = childProp.props).onClick) == null ? void 0 : _b2.call(_a2, e_0);
  }, [childProp == null ? void 0 : childProp.props, handleIsOpenChange]), handleContextMenu = (0, import_react48.useCallback)((e_1) => {
    var _a2, _b2;
    handleIsOpenChange(false, true), (_b2 = childProp == null ? void 0 : (_a2 = childProp.props).onContextMenu) == null ? void 0 : _b2.call(_a2, e_1);
  }, [childProp == null ? void 0 : childProp.props, handleIsOpenChange]), handleFocus = (0, import_react48.useCallback)((e_2) => {
    var _a2, _b2;
  ...
  }, [childProp == null ? void 0 : childProp.props, handleIsOpenChange]), handleMouseEnter = (0, import_react48.useCallback)((e_3) => {
    var _a2, _b2;
  ...
  }, [childProp == null ? void 0 : childProp.props, handleIsOpenChange]), handleMouseLeave = (0, import_react48.useCallback)((e_4) => {
    var _a2, _b2;
  ...
  }, [disabled, handleIsOpenChange, showTooltip]), (0, import_react48.useEffect)(() => {
    !content && showTooltip && handleIsOpenChange(false);
  }, [content, handleIsOpenChange, showTooltip]), (0, import_react48.useEffect)(() => refs.setReference(referenceElement), [referenceElement, refs]), (0, import_react48.useEffect)(() => {
    if (!showTooltip)
      return;
  ...
  }, [handleIsOpenChange, showTooltip]), (0, import_react48.useLayoutEffect)(() => {
  ...
  const setArrow = (0, import_react48.useCallback)((arrowEl) => {
    arrowRef.current = arrowEl, update();
  }, [update]), setFloating = (0, import_react48.useCallback)((node2) => {
    ref.current = node2, refs.setFloating(node2);
  }, [refs]), childRef = (0, import_react48.useRef)(null);
  (0, import_react48.useImperativeHandle)(childProp == null ? void 0 : childProp.ref, () => childRef.current);
  const child = (0, import_react48.useMemo)(() => childProp ? (0, import_react48.cloneElement)(childProp, {
    onBlur: handleBlur,
    onFocus: handleFocus,
...
function useCloseOnMouseLeave(t0) {
  ...
  let t1;
  $2[0] !== referenceElement || $2[1] !== handleIsOpenChange ? (t1 = (target, teardown) => {
  ...
  }, $2[0] = referenceElement, $2[1] = handleIsOpenChange, $2[2] = t1) : t1 = $2[2];
  const onMouseMove = useEffectEvent(t1);
  let t2, t3;
  $2[3] !== showTooltip || $2[4] !== onMouseMove ? (t2 = () => {
    if (!showTooltip)
      return;
  ...
  }, t3 = [onMouseMove, showTooltip], $2[3] = showTooltip, $2[4] = onMouseMove, $2[5] = t2, $2[6] = t3) : (t2 = $2[5], t3 = $2[6]), (0, import_react48.useEffect)(t2, t3);
}
var Root$9 = dt.div`
  line-height: 0;
`;
...
function AutocompleteOption(props) {
  ...
  let t2;
  return $2[5] !== selected || $2[6] !== id3 || $2[7] !== handleClick || $2[8] !== handleKeyDown || $2[9] !== children ? (t2 = (0, import_jsx_runtime.jsx)("li", { "aria-selected": selected, "data-ui": "AutocompleteOption", id: id3, role: "option", onClick: handleClick, onKeyDown: handleKeyDown, children }), $2[5] = selected, $2[6] = id3, $2[7] = handleClick, $2[8] = handleKeyDown, $2[9] = children, $2[10] = t2) : t2 = $2[10], t2;
}
...
var InnerAutocomplete = (0, import_react48.forwardRef)(function(props, forwardedRef) {
  const {
    border: border2 = true,
    customValidity,
    disabled,
    ...
    value: valueProp,
    ...restProps
  } = props, [state, dispatch] = (0, import_react48.useReducer)(autocompleteReducer, {
    ...
    query,
    value
  } = state, defaultRenderOption = (0, import_react48.useCallback)(({
    value: value_0
  }) => (0, import_jsx_runtime.jsx)(Card, { "data-as": "button", padding: paddingProp, radius: 2, tone: "inherit", children: (0, import_jsx_runtime.jsx)(Text, { size: fontSize2, textOverflow: "ellipsis", children: value_0 }) }), [fontSize2, paddingProp]), renderOption = typeof renderOptionProp == "function" ? renderOptionProp : defaultRenderOption, filterOption = typeof filterOptionProp == "function" ? filterOptionProp : DEFAULT_FILTER_OPTION, rootElementRef = (0, import_react48.useRef)(null), resultsPopoverElementRef = (0, import_react48.useRef)(null), inputElementRef = (0, import_react48.useRef)(null), listBoxElementRef = (0, import_react48.useRef)(null), listFocusedRef = (0, import_react48.useRef)(false), valueRef = (0, import_react48.useRef)(value), valuePropRef = (0, import_react48.useRef)(valueProp), popoverMouseWithinRef = (0, import_react48.useRef)(false);
  (0, import_react48.useImperativeHandle)(forwardedRef, () => inputElementRef.current);
  const listBoxId = `${id3}-listbox`, options = Array.isArray(optionsProp) ? optionsProp : EMPTY_ARRAY, padding = useArrayProp(paddingProp), currentOption = (0, import_react48.useMemo)(() => value !== null ? options.find((o2) => o2.value === value) : void 0, [options, value]), filteredOptions = (0, import_react48.useMemo)(() => options.filter((option) => query ? filterOption(query, option) : true), [filterOption, options, query]), filteredOptionsLen = filteredOptions.length, activeItemId = activeValue ? `${id3}-option-${activeValue}` : void 0, expanded = query !== null && loading || focused && query !== null, handleRootBlur = (0, import_react48.useCallback)((event) => {
    setTimeout(() => {
  ...
  }, [onBlur, onQueryChange, relatedElements]), handleRootFocus = (0, import_react48.useCallback)((event_0) => {
  ...
  }, []), handleOptionSelect = (0, import_react48.useCallback)((v2) => {
    var _a;
    dispatch({
      type: "value/change",
      value: v2
  ...
  }, [onChange, onSelect, onQueryChange]), handleRootKeyDown = (0, import_react48.useCallback)((event_1) => {
    var _a, _b;
  ...
  }, [activeValue, filteredOptions, filteredOptionsLen, onQueryChange]), handleInputChange = (0, import_react48.useCallback)((event_2) => {
    const nextQuery = event_2.currentTarget.value;
    dispatch({
      type: "input/change",
      query: nextQuery
    }), onQueryChange && onQueryChange(nextQuery);
  }, [onQueryChange]), dispatchOpen = (0, import_react48.useCallback)(() => {
    dispatch({
      type: "root/open",
      query: value ? renderValue(value, currentOption) : ""
    });
  }, [currentOption, renderValue, value]), handleInputFocus = (0, import_react48.useCallback)((event_3) => {
    focused || (dispatch({
      type: "input/focus"
    }), onFocus && onFocus(event_3), openOnFocus && dispatchOpen());
  }, [focused, onFocus, openOnFocus, dispatchOpen]), handlePopoverMouseEnter = (0, import_react48.useCallback)(() => {
    popoverMouseWithinRef.current = true;
  }, []), handlePopoverMouseLeave = (0, import_react48.useCallback)(() => {
    popoverMouseWithinRef.current = false;
  }, []), handleClearButtonClick = (0, import_react48.useCallback)(() => {
    var _a;
    dispatch({
      type: "root/clear"
    }), valueRef.current = "", onChange && onChange(""), onQueryChange && onQueryChange(null), (_a = inputElementRef.current) == null ? void 0 : _a.focus();
  }, [onChange, onQueryChange]), handleClearButtonFocus = (0, import_react48.useCallback)(() => {
    dispatch({
      type: "input/focus"
    });
  }, []);
  ...
  }, [valueProp]), (0, import_react48.useEffect)(() => {
    !focused && valueRef.current && dispatch({
      type: "root/setActiveValue",
      value: valueRef.current
    });
  }, [focused]), (0, import_react48.useEffect)(() => {
  ...
  const clearButton = (0, import_react48.useMemo)(() => {
    if (!loading && !disabled && value)
      return {
        "aria-label": "Clear",
        onFocus: handleClearButtonFocus
      };
  }, [disabled, handleClearButtonFocus, loading, value]), openButtonBoxPadding = (0, import_react48.useMemo)(() => padding.map((v_0) => v_0 === 0 ? 0 : v_0 === 1 || v_0 === 2 ? 1 : v_0 - 2), [padding]), openButtonPadding = (0, import_react48.useMemo)(() => padding.map((v_1) => Math.max(v_1 - 1, 0)), [padding]), openButtonProps = (0, import_react48.useMemo)(() => typeof openButton == "object" ? openButton : EMPTY_RECORD, [openButton]), handleOpenClick = (0, import_react48.useCallback)((event_4) => {
  ...
  }, [openButtonProps, dispatchOpen]), openButtonNode = (0, import_react48.useMemo)(() => !disabled && !readOnly && openButton ? (0, import_jsx_runtime.jsx)(Box, { "aria-hidden": expanded, padding: openButtonBoxPadding, children: (0, import_jsx_runtime.jsx)(Button, { "aria-label": "Open", disabled: expanded, fontSize: fontSize2, icon: ChevronDownIcon, mode: "bleed", padding: openButtonPadding, ...openButtonProps, onClick: handleOpenClick }) }) : void 0, [disabled, expanded, fontSize2, handleOpenClick, openButton, openButtonBoxPadding, openButtonPadding, openButtonProps, readOnly]), inputValue = (0, import_react48.useMemo)(() => query === null ? value !== null ? renderValue(value, currentOption) : "" : query, [currentOption, query, renderValue, value]), input = (0, import_jsx_runtime.jsx)(TextInput, { ...restProps, "aria-activedescendant": activeItemId, "aria-autocomplete": "list", "aria-expanded": expanded, "aria-owns": listBoxId, autoCapitalize: "off", autoComplete: "off", autoCorrect: "off", border: border2, clearButton, customValidity, disabled, fontSize: fontSize2, icon, iconRight: loading && AnimatedSpinnerIcon, id: id3, inputMode: "search", onChange: handleInputChange, onClear: handleClearButtonClick, onFocus: handleInputFocus, padding, prefix: prefix2, radius, readOnly, ref: inputElementRef, role: "combobox", spellCheck: false, suffix: suffix || openButtonNode, value: inputValue }), handleListBoxKeyDown = (0, import_react48.useCallback)((event_5) => {
    var _a;
    event_5.key === "Tab" && listFocused && ((_a = inputElementRef.current) == null ? void 0 : _a.focus());
  }, [listFocused]), content = (0, import_react48.useMemo)(() => filteredOptions.length === 0 ? null : (0, import_jsx_runtime.jsx)(ListBox, { "data-ui": "AutoComplete__results", onKeyDown: handleListBoxKeyDown, padding: 1, ...listBox, tabIndex: -1, children: (0, import_jsx_runtime.jsx)(Stack, { as: "ul", "aria-multiselectable": false, "data-ui": "AutoComplete__resultsList", id: listBoxId, ref: listBoxElementRef, role: "listbox", space: 1, children: filteredOptions.map((option_0) => {
    const active = activeValue !== null ? option_0.value === activeValue : currentOption === option_0;
    return (0, import_jsx_runtime.jsx)(AutocompleteOption, { id: `${id3}-option-${option_0.value}`, onSelect: handleOptionSelect, selected: active, value: option_0.value, children: (0, import_react48.cloneElement)(renderOption(option_0), {
      disabled: loading,
      selected: active,
      tabIndex: listFocused && active ? 0 : -1
    }) }, option_0.value);
  }) }) }), [activeValue, currentOption, filteredOptions, handleOptionSelect, handleListBoxKeyDown, id3, listBox, listBoxId, listFocused, loading, renderOption]), results = (0, import_react48.useMemo)(() => renderPopover ? renderPopover({
    content,
    hidden: !expanded,
    inputElement: inputElementRef.current,
    onMouseEnter: handlePopoverMouseEnter,
    onMouseLeave: handlePopoverMouseLeave
  }, resultsPopoverElementRef) : filteredOptionsLen === 0 ? null : (0, import_jsx_runtime.jsx)(Popover, { arrow: false, constrainSize: true, content, fallbackPlacements: AUTOCOMPLETE_POPOVER_FALLBACK_PLACEMENTS, matchReferenceWidth: true, onMouseEnter: handlePopoverMouseEnter, onMouseLeave: handlePopoverMouseLeave, open: expanded, overflow: "auto", placement: AUTOCOMPLETE_POPOVER_PLACEMENT, portal: true, radius, ref: resultsPopoverElementRef, referenceElement: inputElementRef.current, ...popover }), [content, expanded, filteredOptionsLen, handlePopoverMouseEnter, handlePopoverMouseLeave, popover, radius, renderPopover]);
  return (0, import_jsx_runtime.jsxs)(Root$9, { "data-ui": "Autocomplete", onBlur: handleRootBlur, onFocus: handleRootFocus, onKeyDown: handleRootKeyDown, ref: rootElementRef, children: [
    input,
    results
  ] });
});
...
var ExpandButton = dt(Button)`
  ...
  margin: -4px;
`;
var Breadcrumbs = (0, import_react48.forwardRef)(function(props, ref) {
  const {
    children,
    maxLength,
    separator,
    space: spaceRaw = 2,
    ...restProps
  } = props, space = useArrayProp(spaceRaw), [open, setOpen] = (0, import_react48.useState)(false), expandElementRef = (0, import_react48.useRef)(null), popoverElementRef = (0, import_react48.useRef)(null), collapse = (0, import_react48.useCallback)(() => setOpen(false), []), expand = (0, import_react48.useCallback)(() => setOpen(true), []);
  useClickOutsideEvent(collapse, () => [expandElementRef.current, popoverElementRef.current]);
  const rawItems = (0, import_react48.useMemo)(() => import_react48.Children.toArray(children).filter(import_react48.isValidElement), [children]), items = (0, import_react48.useMemo)(() => {
    const len = rawItems.length;
    if (maxLength && len > maxLength) {
      const beforeLength = Math.ceil(maxLength / 2), afterLength = Math.floor(maxLength / 2);
      return [...rawItems.slice(0, beforeLength - 1), (0, import_jsx_runtime.jsx)(Popover, { constrainSize: true, content: (0, import_jsx_runtime.jsx)(Stack, { as: "ol", overflow: "auto", padding: space, space, children: rawItems.slice(beforeLength - 1, len - afterLength) }), open, placement: "top", portal: true, ref: popoverElementRef, children: (0, import_jsx_runtime.jsx)(ExpandButton, { fontSize: 1, mode: "bleed", onClick: open ? collapse : expand, padding: 1, ref: expandElementRef, selected: open, text: "…" }) }, "button"), ...rawItems.slice(len - afterLength)];
    }
    return rawItems;
  }, [collapse, expand, maxLength, open, rawItems, space]);
  return (0, import_jsx_runtime.jsx)(Root$8, { "data-ui": "Breadcrumbs", ...restProps, ref, children: items.map((item, itemIndex) => (0, import_jsx_runtime.jsxs)(import_react48.Fragment, { children: [
    itemIndex > 0 && (0, import_jsx_runtime.jsx)(Box, { "aria-hidden": true, as: "li", paddingX: space, children: separator || (0, import_jsx_runtime.jsx)(Text, { muted: true, children: "/" }) }),
    (0, import_jsx_runtime.jsx)(Box, { as: "li", children: item })
  ] }, itemIndex)) });
});
...
function useDialog() {
  return (0, import_react48.useContext)(DialogContext);
}
...
var DialogFooter = dt(Box)`
  ...
  z-index: 3;
`;
var DialogCard = (0, import_react48.forwardRef)(function(props, forwardedRef) {
  var _a;
  const $2 = (0, import_react_compiler_runtime.c)(38), {
    ...
    shadow: shadowProp,
    width: widthProp
  } = props, portal = usePortal(), portalElement = portalProp ? ((_a = portal.elements) == null ? void 0 : _a[portalProp]) || null : portal.element, boundaryElement = useBoundaryElement().element, radius = useArrayProp(radiusProp), shadow = useArrayProp(shadowProp), width = useArrayProp(widthProp), ref = (0, import_react48.useRef)(null), contentRef = (0, import_react48.useRef)(null), layer = useLayer(), {
    isTopLayer: isTopLayer2
  } = layer, labelId = `${id3}_label`, showCloseButton = !!onClose && hideCloseButton === false, showHeader = !!header || showCloseButton;
  let t0;
  $2[0] === Symbol.for("react.memo_cache_sentinel") ? (t0 = () => ref.current, $2[0] = t0) : t0 = $2[0], (0, import_react48.useImperativeHandle)(forwardedRef, t0);
  let t1;
  $2[1] === Symbol.for("react.memo_cache_sentinel") ? (t1 = () => contentRef.current, $2[1] = t1) : t1 = $2[1], (0, import_react48.useImperativeHandle)(forwardedContentRef, t1);
  let t2, t3;
  $2[2] !== autoFocus ? (t2 = () => {
    autoFocus && ref.current && focusFirstDescendant(ref.current);
  }, t3 = [autoFocus, ref], $2[2] = autoFocus, $2[3] = t2, $2[4] = t3) : (t2 = $2[3], t3 = $2[4]), (0, import_react48.useEffect)(t2, t3);
  let t4;
  $2[5] !== isTopLayer2 || $2[6] !== onClose || $2[7] !== boundaryElement || $2[8] !== portalElement ? (t4 = (event) => {
    if (!isTopLayer2 || !onClose)
      return;
    const target = document.activeElement;
    target && !isTargetWithinScope(boundaryElement, portalElement, target) || event.key === "Escape" && (event.preventDefault(), event.stopPropagation(), onClose());
  }, $2[5] = isTopLayer2, $2[6] = onClose, $2[7] = boundaryElement, $2[8] = portalElement, $2[9] = t4) : t4 = $2[9], useGlobalKeyDown(t4);
  let t5;
  $2[10] !== isTopLayer2 || $2[11] !== onClickOutside || $2[12] !== boundaryElement || $2[13] !== portalElement ? (t5 = isTopLayer2 && onClickOutside && ((event_0) => {
    const target_0 = event_0.target;
    target_0 && !isTargetWithinScope(boundaryElement, portalElement, target_0) || onClickOutside();
  }), $2[10] = isTopLayer2, $2[11] = onClickOutside, $2[12] = boundaryElement, $2[13] = portalElement, $2[14] = t5) : t5 = $2[14];
  let t6;
  $2[15] === Symbol.for("react.memo_cache_sentinel") ? (t6 = () => [ref.current], $2[15] = t6) : t6 = $2[15], useClickOutsideEvent(t5, t6);
  let t7;
  $2[16] !== showHeader || $2[17] !== header || $2[18] !== labelId || $2[19] !== showCloseButton || $2[20] !== onClose ? (t7 = showHeader && (0, import_jsx_runtime.jsx)(DialogHeader, { children: (0, import_jsx_runtime.jsxs)(Flex, { align: "flex-start", padding: 3, children: [
    (0, import_jsx_runtime.jsx)(Box, { flex: 1, padding: 2, children: header && (0, import_jsx_runtime.jsx)(Text, { id: labelId, size: 1, weight: "semibold", children: header }) }),
    showCloseButton && (0, import_jsx_runtime.jsx)(Box, { flex: "none", children: (0, import_jsx_runtime.jsx)(Button, { "aria-label": "Close dialog", disabled: !onClose, icon: CloseIcon, mode: "bleed", onClick: onClose, padding: 2 }) })
  ] }) }), $2[16] = showHeader, $2[17] = header, $2[18] = labelId, $2[19] = showCloseButton, $2[20] = onClose, $2[21] = t7) : t7 = $2[21];
  let t8;
  $2[22] !== children ? (t8 = (0, import_jsx_runtime.jsx)(DialogContent, { flex: 1, ref: contentRef, tabIndex: -1, children }), $2[22] = children, $2[23] = t8) : t8 = $2[23];
  let t9;
  $2[24] !== footer ? (t9 = footer && (0, import_jsx_runtime.jsx)(DialogFooter, { children: footer }), $2[24] = footer, $2[25] = t9) : t9 = $2[25];
  let t10;
  $2[26] !== t7 || $2[27] !== t8 || $2[28] !== t9 ? (t10 = (0, import_jsx_runtime.jsxs)(DialogLayout, { direction: "column", children: [
    t7,
    t8,
    t9
  ] }), $2[26] = t7, $2[27] = t8, $2[28] = t9, $2[29] = t10) : t10 = $2[29];
  let t11;
  $2[30] !== radius || $2[31] !== scheme || $2[32] !== shadow || $2[33] !== t10 ? (t11 = (0, import_jsx_runtime.jsx)(DialogCardRoot, { radius, ref, scheme, shadow, children: t10 }), $2[30] = radius, $2[31] = scheme, $2[32] = shadow, $2[33] = t10, $2[34] = t11) : t11 = $2[34];
  let t12;
  return $2[35] !== width || $2[36] !== t11 ? (t12 = (0, import_jsx_runtime.jsx)(DialogContainer, { "data-ui": "DialogCard", width, children: t11 }), $2[35] = width, $2[36] = t11, $2[37] = t12) : t12 = $2[37], t12;
});
DialogCard.displayName = "ForwardRef(DialogCard)";
var Dialog = (0, import_react48.forwardRef)(function(props, ref) {
  var _a;
  const $2 = (0, import_react_compiler_runtime.c)(60), dialog = useDialog(), {
    layer
  } = useTheme_v2();
  let t0, t1, t2, t3, t4, t5, t6, _positionProp, _zOffsetProp, portalProp, onFocus, id3, contentRef, footer, header, onClickOutside, onClose, scheme, children, restProps, onActivate;
  $2[0] !== props ? ({
    ...
    animate: t6,
    ...restProps
  } = props, $2[0] = props, $2[1] = t0, $2[2] = t1, $2[3] = t2, $2[4] = t3, $2[5] = t4, $2[6] = t5, $2[7] = t6, $2[8] = _positionProp, $2[9] = _zOffsetProp, $2[10] = portalProp, $2[11] = onFocus, $2[12] = id3, $2[13] = contentRef, $2[14] = footer, $2[15] = header, $2[16] = onClickOutside, $2[17] = onClose, $2[18] = scheme, $2[19] = children, $2[20] = restProps, $2[21] = onActivate) : (t0 = $2[1], t1 = $2[2], t2 = $2[3], t3 = $2[4], t4 = $2[5], t5 = $2[6], t6 = $2[7], _positionProp = $2[8], _zOffsetProp = $2[9], portalProp = $2[10], onFocus = $2[11], id3 = $2[12], contentRef = $2[13], footer = $2[14], header = $2[15], onClickOutside = $2[16], onClose = $2[17], scheme = $2[18], children = $2[19], restProps = $2[20], onActivate = $2[21]);
  const autoFocus = t0 === void 0 ? true : t0, hideCloseButton = t1 === void 0 ? false : t1, cardRadiusProp = t2 === void 0 ? 4 : t2, cardShadow = t3 === void 0 ? 3 : t3, paddingProp = t4 === void 0 ? 3 : t4, widthProp = t5 === void 0 ? 0 : t5, _animate = t6 === void 0 ? false : t6, positionProp = _positionProp ?? (dialog.position || "fixed"), zOffsetProp = _zOffsetProp ?? (dialog.zOffset || layer.dialog.zOffset), animate2 = usePrefersReducedMotion() ? false : _animate, portal = usePortal(), portalElement = portalProp ? ((_a = portal.elements) == null ? void 0 : _a[portalProp]) || null : portal.element, boundaryElement = useBoundaryElement().element, cardRadius = useArrayProp(cardRadiusProp), padding = useArrayProp(paddingProp), position2 = useArrayProp(positionProp), width = useArrayProp(widthProp), zOffset = useArrayProp(zOffsetProp), preDivRef = (0, import_react48.useRef)(null), postDivRef = (0, import_react48.useRef)(null), cardRef = (0, import_react48.useRef)(null), focusedElementRef = (0, import_react48.useRef)(null);
  let t7;
  ...
  const handleFocus = t7, labelId = `${id3}_label`, rootClickTimeoutRef = (0, import_react48.useRef)();
  let t8;
  ...
  let t9;
  $2[27] === Symbol.for("react.memo_cache_sentinel") ? (t9 = (0, import_jsx_runtime.jsx)("div", { ref: preDivRef, tabIndex: 0 }), $2[27] = t9) : t9 = $2[27];
  let t10;
  $2[28] !== autoFocus || $2[29] !== hideCloseButton || $2[30] !== contentRef || $2[31] !== footer || $2[32] !== header || $2[33] !== id3 || $2[34] !== onClickOutside || $2[35] !== onClose || $2[36] !== portalProp || $2[37] !== cardRadius || $2[38] !== scheme || $2[39] !== cardShadow || $2[40] !== width || $2[41] !== children ? (t10 = (0, import_jsx_runtime.jsx)(DialogCard, { __unstable_autoFocus: autoFocus, __unstable_hideCloseButton: hideCloseButton, contentRef, footer, header, id: id3, onClickOutside, onClose, portal: portalProp, radius: cardRadius, ref: cardRef, scheme, shadow: cardShadow, width, children }), $2[28] = autoFocus, $2[29] = hideCloseButton, $2[30] = contentRef, $2[31] = footer, $2[32] = header, $2[33] = id3, $2[34] = onClickOutside, $2[35] = onClose, $2[36] = portalProp, $2[37] = cardRadius, $2[38] = scheme, $2[39] = cardShadow, $2[40] = width, $2[41] = children, $2[42] = t10) : t10 = $2[42];
  let t11;
  $2[43] === Symbol.for("react.memo_cache_sentinel") ? (t11 = (0, import_jsx_runtime.jsx)("div", { ref: postDivRef, tabIndex: 0 }), $2[43] = t11) : t11 = $2[43];
  let t12;
  $2[44] !== restProps || $2[45] !== animate2 || $2[46] !== padding || $2[47] !== position2 || $2[48] !== labelId || $2[49] !== id3 || $2[50] !== onActivate || $2[51] !== handleRootClick || $2[52] !== handleFocus || $2[53] !== ref || $2[54] !== zOffset || $2[55] !== t10 ? (t12 = (0, import_jsx_runtime.jsxs)(Root$7, { ...restProps, $animate: animate2, $padding: padding, $position: position2, "aria-labelledby": labelId, "aria-modal": true, "data-ui": "Dialog", id: id3, onActivate, onClick: handleRootClick, onFocus: handleFocus, ref, role: "dialog", zOffset, children: [
    t9,
    t10,
    t11
  ] }), $2[44] = restProps, $2[45] = animate2, $2[46] = padding, $2[47] = position2, $2[48] = labelId, $2[49] = id3, $2[50] = onActivate, $2[51] = handleRootClick, $2[52] = handleFocus, $2[53] = ref, $2[54] = zOffset, $2[55] = t10, $2[56] = t12) : t12 = $2[56];
  let t13;
  return $2[57] !== portalProp || $2[58] !== t12 ? (t13 = (0, import_jsx_runtime.jsx)(Portal, { __unstable_name: portalProp, children: t12 }), $2[57] = portalProp, $2[58] = t12, $2[59] = t13) : t13 = $2[59], t13;
});
...
function DialogProvider(props) {
  ...
  let t2;
  return $2[3] !== contextValue || $2[4] !== children ? (t2 = (0, import_jsx_runtime.jsx)(DialogContext.Provider, { value: contextValue, children }), $2[3] = contextValue, $2[4] = children, $2[5] = t2) : t2 = $2[5], t2;
}
...
`;
var Hotkeys = (0, import_react48.forwardRef)(function(props, ref) {
  const $2 = (0, import_react_compiler_runtime.c)(24);
  ...
  $2[0] !== props ? ({
    ...
    space: t0,
    ...restProps
  } = props, $2[0] = props, $2[1] = t0, $2[2] = keys, $2[3] = fontSize2, $2[4] = padding, $2[5] = radius, $2[6] = restProps) : (t0 = $2[1], keys = $2[2], fontSize2 = $2[3], padding = $2[4], radius = $2[5], restProps = $2[6]);
  const space = useArrayProp(t0 === void 0 ? 0.5 : t0);
  if (!keys || keys.length === 0) {
    let t12;
    return $2[7] === Symbol.for("react.memo_cache_sentinel") ? (t12 = (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, {}), $2[7] = t12) : t12 = $2[7], t12;
  }
  let t1;
  if ($2[8] !== fontSize2 || $2[9] !== padding || $2[10] !== radius || $2[11] !== keys) {
    let t22;
    $2[13] !== fontSize2 || $2[14] !== padding || $2[15] !== radius ? (t22 = (key2, i2) => (0, import_jsx_runtime.jsx)(Key, { fontSize: fontSize2, padding, radius, children: key2 }, i2), $2[13] = fontSize2, $2[14] = padding, $2[15] = radius, $2[16] = t22) : t22 = $2[16], t1 = keys.map(t22), $2[8] = fontSize2, $2[9] = padding, $2[10] = radius, $2[11] = keys, $2[12] = t1;
  } else
    t1 = $2[12];
  let t2;
  $2[17] !== space || $2[18] !== t1 ? (t2 = (0, import_jsx_runtime.jsx)(Inline, { as: "span", space, children: t1 }), $2[17] = space, $2[18] = t1, $2[19] = t2) : t2 = $2[19];
  let t3;
  return $2[20] !== restProps || $2[21] !== ref || $2[22] !== t2 ? (t3 = (0, import_jsx_runtime.jsx)(Root$6, { "data-ui": "Hotkeys", ...restProps, ref, children: t2 }), $2[20] = restProps, $2[21] = ref, $2[22] = t2, $2[23] = t3) : t3 = $2[23], t3;
});
...
function useMenuController(props) {
  const {
    ...
    shouldFocus,
    rootElementRef
  } = props, elementsRef = (0, import_react48.useRef)([]), [activeIndex, _setActiveIndex] = (0, import_react48.useState)(-1), activeIndexRef = (0, import_react48.useRef)(activeIndex), activeElement = (0, import_react48.useMemo)(() => elementsRef.current[activeIndex] || null, [activeIndex]), mounted = !!rootElementRef.current, setActiveIndex = (0, import_react48.useCallback)((nextActiveIndex) => {
    _setActiveIndex(nextActiveIndex), activeIndexRef.current = nextActiveIndex;
  }, []), mount = (0, import_react48.useCallback)((element, selected) => {
    if (!element)
      return () => {
      };
  ...
  }, [rootElementRef, setActiveIndex]), handleKeyDown = (0, import_react48.useCallback)((event) => {
    if (event.key === "Tab") {
  ...
  }, [onKeyDown, originElement, setActiveIndex]), handleItemMouseEnter = (0, import_react48.useCallback)((event_0) => {
    const element_0 = event_0.currentTarget, currentIndex_3 = elementsRef.current.indexOf(element_0);
    setActiveIndex(currentIndex_3);
  }, [setActiveIndex]), handleItemMouseLeave = (0, import_react48.useCallback)(() => {
    var _a;
...
var Root$5 = dt(Box)`
  ...
  overflow: auto;
`;
var Menu = (0, import_react48.forwardRef)(function(props, forwardedRef) {
  ...
  if ($2[0] !== props) {
    ...
    children = t22, onClickOutside = t32, onEscape = t42, onItemClick = t52, onItemSelect = t62, onKeyDown = t72, originElement = t82, t0 = t92, registerElement = t102, _shouldFocus = t112, t1 = t122, restProps = t132, $2[0] = props, $2[1] = t0, $2[2] = t1, $2[3] = _shouldFocus, $2[4] = onKeyDown, $2[5] = originElement, $2[6] = registerElement, $2[7] = onItemSelect, $2[8] = onClickOutside, $2[9] = onEscape, $2[10] = onItemClick, $2[11] = children, $2[12] = restProps;
  } else
    t0 = $2[1], t1 = $2[2], _shouldFocus = $2[3], onKeyDown = $2[4], originElement = $2[5], registerElement = $2[6], onItemSelect = $2[7], onClickOutside = $2[8], onEscape = $2[9], onItemClick = $2[10], children = $2[11], restProps = $2[12];
  const padding = t0 === void 0 ? 1 : t0, space = t1 === void 0 ? 1 : t1, shouldFocus = _shouldFocus ?? (props.focusFirst && "first" || props.focusLast && "last" || null), ref = (0, import_react48.useRef)(null);
  let t2;
  $2[13] === Symbol.for("react.memo_cache_sentinel") ? (t2 = () => ref.current, $2[13] = t2) : t2 = $2[13], (0, import_react48.useImperativeHandle)(forwardedRef, t2);
  const {
    isTopLayer: isTopLayer2
  } = useLayer();
  let t3;
  ...
  const {
    ...
    handleKeyDown,
    mount
  } = useMenuController(t3), unregisterElementRef = (0, import_react48.useRef)(null);
  let t4;
  ...
  let t5, t6;
  $2[20] !== onItemSelect || $2[21] !== activeIndex ? (t5 = () => {
    onItemSelect && onItemSelect(activeIndex);
  }, t6 = [activeIndex, onItemSelect], $2[20] = onItemSelect, $2[21] = activeIndex, $2[22] = t5, $2[23] = t6) : (t5 = $2[22], t6 = $2[23]), (0, import_react48.useEffect)(t5, t6);
  let t7;
  ...
  let t9, t10;
  $2[28] !== activeElement || $2[29] !== activeIndex || $2[30] !== mount || $2[31] !== onClickOutside || $2[32] !== onEscape || $2[33] !== onItemClick || $2[34] !== handleItemMouseEnter || $2[35] !== handleItemMouseLeave || $2[36] !== registerElement ? (t10 = {
    version: 0,
    activeElement,
    activeIndex,
    mount,
  ...
  }, $2[28] = activeElement, $2[29] = activeIndex, $2[30] = mount, $2[31] = onClickOutside, $2[32] = onEscape, $2[33] = onItemClick, $2[34] = handleItemMouseEnter, $2[35] = handleItemMouseLeave, $2[36] = registerElement, $2[37] = t10) : t10 = $2[37], t9 = t10;
  const value = t9;
  let t11;
  $2[38] !== space || $2[39] !== children ? (t11 = (0, import_jsx_runtime.jsx)(Stack, { space, children }), $2[38] = space, $2[39] = children, $2[40] = t11) : t11 = $2[40];
  let t12;
  $2[41] !== restProps || $2[42] !== handleKeyDown || $2[43] !== padding || $2[44] !== handleRefChange || $2[45] !== t11 ? (t12 = (0, import_jsx_runtime.jsx)(Root$5, { "data-ui": "Menu", ...restProps, onKeyDown: handleKeyDown, padding, ref: handleRefChange, role: "menu", tabIndex: -1, children: t11 }), $2[41] = restProps, $2[42] = handleKeyDown, $2[43] = padding, $2[44] = handleRefChange, $2[45] = t11, $2[46] = t12) : t12 = $2[46];
  let t13;
  return $2[47] !== value || $2[48] !== t12 ? (t13 = (0, import_jsx_runtime.jsx)(MenuContext.Provider, { value, children: t12 }), $2[47] = value, $2[48] = t12, $2[49] = t13) : t13 = $2[49], t13;
});
Menu.displayName = "ForwardRef(Menu)";
var MenuButton = (0, import_react48.forwardRef)(function(props, forwardedRef) {
  const {
  ...
  } = props, [open, setOpen] = (0, import_react48.useState)(false), [shouldFocus, setShouldFocus] = (0, import_react48.useState)(null), [buttonElement, setButtonElement] = (0, import_react48.useState)(null), [menuElements, setChildMenuElements] = (0, import_react48.useState)([]), openRef = (0, import_react48.useRef)(open);
  (0, import_react48.useEffect)(() => {
    onOpen && open && !openRef.current && onOpen();
  }, [onOpen, open]), (0, import_react48.useEffect)(() => {
    onClose && !open && openRef.current && onClose();
  }, [onClose, open]), (0, import_react48.useEffect)(() => {
    openRef.current = open;
  }, [open]);
  const handleButtonClick = (0, import_react48.useCallback)(() => {
    setOpen((v2) => !v2), setShouldFocus(null);
  }, []), handleMouseDown = (0, import_react48.useCallback)((event) => {
    open && event.preventDefault();
  }, [open]), handleButtonKeyDown = (0, import_react48.useCallback)((event_0) => {
  ...
  }, []), handleMenuClickOutside = (0, import_react48.useCallback)((event_1) => {
  ...
  }, [buttonElement, menuElements]), handleMenuEscape = (0, import_react48.useCallback)(() => {
    setOpen(false), !disableRestoreFocusOnClose && buttonElement && buttonElement.focus();
  }, [buttonElement, disableRestoreFocusOnClose]), handleBlur = (0, import_react48.useCallback)((event_2) => {
  ...
  }, [menuElements]), handleItemClick = (0, import_react48.useCallback)(() => {
    setOpen(false), !disableRestoreFocusOnClose && buttonElement && buttonElement.focus();
  }, [buttonElement, disableRestoreFocusOnClose]), registerElement = (0, import_react48.useCallback)((el_1) => (setChildMenuElements((els) => els.concat([el_1])), () => setChildMenuElements((els_0) => els_0.filter((_el) => _el !== el_1))), []), menuProps = (0, import_react48.useMemo)(() => ({
    "aria-labelledby": id3,
    ...
    registerElement,
    shouldFocus
  }), [buttonElement, handleMenuClickOutside, handleMenuEscape, handleItemClick, id3, handleBlur, registerElement, shouldFocus]), menu = menuProp && (0, import_react48.cloneElement)(menuProp, menuProps), ref = (0, import_react48.useRef)(null), button = (0, import_react48.useMemo)(() => buttonProp && (0, import_react48.cloneElement)(buttonProp, {
    "data-ui": "MenuButton",
    id: id3,
  ...
  (0, import_react48.useImperativeHandle)(forwardedRef, () => ref.current), (0, import_react48.useEffect)(() => {
    if (button)
      return setButtonElement(ref.current), () => setButtonElement(null);
  }, [button]);
  const popoverProps = (0, import_react48.useMemo)(() => ({
    boundaryElement: deprecated_boundaryElement,
    overflow: "auto",
    placement: deprecated_placement,
  ...
  return (0, import_jsx_runtime.jsx)(Popover, { "data-ui": "MenuButton__popover", ...popoverProps, content: menu, open, children: button || (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, {}) });
});
...
function useMenu() {
  const value = (0, import_react48.useContext)(MenuContext);
  if (!value)
...
function MenuGroup(props) {
  const $2 = (0, import_react_compiler_runtime.c)(77);
  ...
  $2[0] !== props ? ({
    ...
    tone: t5,
    ...restProps
  } = props, $2[0] = props, $2[1] = t0, $2[2] = t1, $2[3] = t2, $2[4] = t3, $2[5] = t4, $2[6] = t5, $2[7] = onClick, $2[8] = children, $2[9] = IconComponent, $2[10] = text, $2[11] = restProps, $2[12] = popover) : (t0 = $2[1], t1 = $2[2], t2 = $2[3], t3 = $2[4], t4 = $2[5], t5 = $2[6], onClick = $2[7], children = $2[8], IconComponent = $2[9], text = $2[10], restProps = $2[11], popover = $2[12]);
  const as = t0 === void 0 ? "button" : t0, fontSize2 = t1 === void 0 ? 1 : t1, padding = t2 === void 0 ? 3 : t2, radius = t3 === void 0 ? 2 : t3, space = t4 === void 0 ? 3 : t4, tone = t5 === void 0 ? "default" : t5, menu = useMenu(), {
    ...
    registerElement
  } = menu, onItemMouseEnter = _onItemMouseEnter ?? menu.onMouseEnter, [rootElement, setRootElement] = (0, import_react48.useState)(null), [open, setOpen] = (0, import_react48.useState)(false), [shouldFocus, setShouldFocus] = (0, import_react48.useState)(null), active = !!activeElement && activeElement === rootElement, [withinMenu, setWithinMenu] = (0, import_react48.useState)(false);
  let t6;
  $2[13] !== onItemMouseEnter ? (t6 = (event) => {
    setWithinMenu(false), onItemMouseEnter(event), setOpen(true);
  }, $2[13] = onItemMouseEnter, $2[14] = t6) : t6 = $2[14];
  const handleMouseEnter = t6;
  let t7;
  $2[15] !== rootElement ? (t7 = (event_0) => {
  ...
  }, $2[15] = rootElement, $2[16] = t7) : t7 = $2[16];
  const handleMenuKeyDown = t7;
  let t8;
  $2[17] !== onClick ? (t8 = (event_1) => {
    onClick == null ? void 0 : onClick(event_1), setShouldFocus("first"), setOpen(true);
  }, $2[17] = onClick, $2[18] = t8) : t8 = $2[18];
  const handleClick = t8;
  let t9;
  $2[19] !== onItemClick ? (t9 = () => {
    setOpen(false), onItemClick == null ? void 0 : onItemClick();
  }, $2[19] = onItemClick, $2[20] = t9) : t9 = $2[20];
  const handleChildItemClick = t9;
  let t10;
  $2[21] === Symbol.for("react.memo_cache_sentinel") ? (t10 = () => setWithinMenu(true), $2[21] = t10) : t10 = $2[21];
  const handleMenuMouseEnter = t10;
  let t11, t12;
  $2[22] !== mount || $2[23] !== rootElement ? (t11 = () => mount(rootElement), t12 = [mount, rootElement], $2[22] = mount, $2[23] = rootElement, $2[24] = t11, $2[25] = t12) : (t11 = $2[24], t12 = $2[25]), (0, import_react48.useEffect)(t11, t12);
  let t13, t14;
  $2[26] !== active ? (t13 = () => {
    active || setOpen(false);
  }, t14 = [active], $2[26] = active, $2[27] = t13, $2[28] = t14) : (t13 = $2[27], t14 = $2[28]), (0, import_react48.useEffect)(t13, t14);
  let t15, t16;
  $2[29] !== open ? (t15 = () => {
    open || setWithinMenu(false);
  }, t16 = [open], $2[29] = open, $2[30] = t15, $2[31] = t16) : (t15 = $2[30], t16 = $2[31]), (0, import_react48.useEffect)(t15, t16);
  let t17, t18;
  $2[32] !== shouldFocus ? (t17 = () => {
    if (!shouldFocus)
      return;
    const rafId = requestAnimationFrame(() => setShouldFocus(null));
    return () => cancelAnimationFrame(rafId);
  }, t18 = [shouldFocus], $2[32] = shouldFocus, $2[33] = t17, $2[34] = t18) : (t17 = $2[33], t18 = $2[34]), (0, import_react48.useEffect)(t17, t18);
  let t19;
  $2[35] !== onClickOutside || $2[36] !== onEscape || $2[37] !== handleChildItemClick || $2[38] !== handleMenuKeyDown || $2[39] !== registerElement || $2[40] !== shouldFocus || $2[41] !== children ? (t19 = (0, import_jsx_runtime.jsx)(Menu, { onClickOutside, onEscape, onItemClick: handleChildItemClick, onKeyDown: handleMenuKeyDown, onMouseEnter: handleMenuMouseEnter, registerElement, shouldFocus, children }), $2[35] = onClickOutside, $2[36] = onEscape, $2[37] = handleChildItemClick, $2[38] = handleMenuKeyDown, $2[39] = registerElement, $2[40] = shouldFocus, $2[41] = children, $2[42] = t19) : t19 = $2[42];
  const childMenu = t19;
  let t20;
  $2[43] === Symbol.for("react.memo_cache_sentinel") ? (t20 = (event_2) => {
  ...
  let t26;
  $2[44] !== IconComponent || $2[45] !== fontSize2 ? (t26 = IconComponent && (0, import_jsx_runtime.jsxs)(Text, { size: fontSize2, children: [
    (0, import_react48.isValidElement)(IconComponent) && IconComponent,
    (0, import_react_is.isValidElementType)(IconComponent) && (0, import_jsx_runtime.jsx)(IconComponent, {})
  ] }), $2[44] = IconComponent, $2[45] = fontSize2, $2[46] = t26) : t26 = $2[46];
  let t27;
  $2[47] !== fontSize2 || $2[48] !== text ? (t27 = (0, import_jsx_runtime.jsx)(Box, { flex: 1, children: (0, import_jsx_runtime.jsx)(Text, { size: fontSize2, textOverflow: "ellipsis", weight: "medium", children: text }) }), $2[47] = fontSize2, $2[48] = text, $2[49] = t27) : t27 = $2[49];
  let t28;
  $2[50] === Symbol.for("react.memo_cache_sentinel") ? (t28 = (0, import_jsx_runtime.jsx)(ChevronRightIcon, {}), $2[50] = t28) : t28 = $2[50];
  let t29;
  $2[51] !== fontSize2 ? (t29 = (0, import_jsx_runtime.jsx)(Text, { size: fontSize2, children: t28 }), $2[51] = fontSize2, $2[52] = t29) : t29 = $2[52];
  let t30;
  $2[53] !== space || $2[54] !== padding || $2[55] !== t26 || $2[56] !== t27 || $2[57] !== t29 ? (t30 = (0, import_jsx_runtime.jsxs)(Flex, { gap: space, padding, children: [
    t26,
    t27,
    t29
  ] }), $2[53] = space, $2[54] = padding, $2[55] = t26, $2[56] = t27, $2[57] = t29, $2[58] = t30) : t30 = $2[58];
  let t31;
  $2[59] !== as || $2[60] !== restProps || $2[61] !== t21 || $2[62] !== t22 || $2[63] !== t23 || $2[64] !== t24 || $2[65] !== tone || $2[66] !== scheme || $2[67] !== handleClick || $2[68] !== handleMouseEnter || $2[69] !== t25 || $2[70] !== t30 ? (t31 = (0, import_jsx_runtime.jsx)(Selectable, { "data-as": as, "data-ui": "MenuGroup", forwardedAs: as, ...restProps, "aria-pressed": t21, "data-pressed": t22, "data-selected": t23, $radius: t24, $tone: tone, $scheme: scheme, onClick: handleClick, onKeyDown: handleKeyDown, onMouseEnter: handleMouseEnter, ref: setRootElement, tabIndex: -1, type: t25, children: t30 }), $2[59] = as, $2[60] = restProps, $2[61] = t21, $2[62] = t22, $2[63] = t23, $2[64] = t24, $2[65] = tone, $2[66] = scheme, $2[67] = handleClick, $2[68] = handleMouseEnter, $2[69] = t25, $2[70] = t30, $2[71] = t31) : t31 = $2[71];
  let t32;
  return $2[72] !== popover || $2[73] !== childMenu || $2[74] !== open || $2[75] !== t31 ? (t32 = (0, import_jsx_runtime.jsx)(Popover, { ...popover, content: childMenu, "data-ui": "MenuGroup__popover", open, children: t31 }), $2[72] = popover, $2[73] = childMenu, $2[74] = open, $2[75] = t31, $2[76] = t32) : t32 = $2[76], t32;
}
MenuGroup.displayName = "MenuGroup";
var MenuItem = (0, import_react48.forwardRef)(function(props, forwardedRef) {
  ...
  $2[0] !== props ? ({
    ...
    tone: t5,
    ...restProps
  } = props, $2[0] = props, $2[1] = t0, $2[2] = t1, $2[3] = t2, $2[4] = t3, $2[5] = t4, $2[6] = t5, $2[7] = selectedProp, $2[8] = disabled, $2[9] = onClick, $2[10] = paddingX, $2[11] = paddingY, $2[12] = paddingTop, $2[13] = paddingRight, $2[14] = paddingBottom, $2[15] = paddingLeft, $2[16] = pressed, $2[17] = IconComponent, $2[18] = text, $2[19] = IconRightComponent, $2[20] = hotkeys, $2[21] = children, $2[22] = restProps) : (t0 = $2[1], t1 = $2[2], t2 = $2[3], t3 = $2[4], t4 = $2[5], t5 = $2[6], selectedProp = $2[7], disabled = $2[8], onClick = $2[9], paddingX = $2[10], paddingY = $2[11], paddingTop = $2[12], paddingRight = $2[13], paddingBottom = $2[14], paddingLeft = $2[15], pressed = $2[16], IconComponent = $2[17], text = $2[18], IconRightComponent = $2[19], hotkeys = $2[20], children = $2[21], restProps = $2[22]);
  ...
  } = menu, onItemMouseEnter = _onItemMouseEnter ?? menu.onMouseEnter, onItemMouseLeave = _onItemMouseLeave ?? menu.onMouseLeave, [rootElement, setRootElement] = (0, import_react48.useState)(null), active = !!activeElement && activeElement === rootElement, ref = (0, import_react48.useRef)(null);
  let t6;
  $2[23] === Symbol.for("react.memo_cache_sentinel") ? (t6 = () => ref.current, $2[23] = t6) : t6 = $2[23], (0, import_react48.useImperativeHandle)(forwardedRef, t6);
  let t7, t8;
  $2[24] !== mount || $2[25] !== rootElement || $2[26] !== selectedProp ? (t7 = () => mount(rootElement, selectedProp), t8 = [mount, rootElement, selectedProp], $2[24] = mount, $2[25] = rootElement, $2[26] = selectedProp, $2[27] = t7, $2[28] = t8) : (t7 = $2[27], t8 = $2[28]), (0, import_react48.useEffect)(t7, t8);
  let t9;
  ...
  let t10, t11;
  $2[33] !== padding || $2[34] !== paddingX || $2[35] !== paddingY || $2[36] !== paddingTop || $2[37] !== paddingRight || $2[38] !== paddingBottom || $2[39] !== paddingLeft ? (t11 = {
    padding,
    paddingX,
    paddingY,
    paddingTop,
    ...
    paddingBottom,
    paddingLeft
  }, $2[33] = padding, $2[34] = paddingX, $2[35] = paddingY, $2[36] = paddingTop, $2[37] = paddingRight, $2[38] = paddingBottom, $2[39] = paddingLeft, $2[40] = t11) : t11 = $2[40], t10 = t11;
  const paddingProps = t10, t12 = useArrayProp(fontSize2);
  let t13;
  $2[41] !== t12 ? (t13 = t12.map(_temp$1), $2[41] = t12, $2[42] = t13) : t13 = $2[42];
  ...
  let t23;
  $2[44] !== IconComponent || $2[45] !== text || $2[46] !== IconRightComponent || $2[47] !== fontSize2 || $2[48] !== hotkeys || $2[49] !== hotkeysFontSize || $2[50] !== space || $2[51] !== paddingProps ? (t23 = (IconComponent || text || IconRightComponent) && (0, import_jsx_runtime.jsxs)(Flex, { as: "span", gap: space, align: "center", ...paddingProps, children: [
    IconComponent && (0, import_jsx_runtime.jsxs)(Text, { size: fontSize2, children: [
      (0, import_react48.isValidElement)(IconComponent) && IconComponent,
      (0, import_react_is.isValidElementType)(IconComponent) && (0, import_jsx_runtime.jsx)(IconComponent, {})
    ] }),
  ...
  ] }), $2[44] = IconComponent, $2[45] = text, $2[46] = IconRightComponent, $2[47] = fontSize2, $2[48] = hotkeys, $2[49] = hotkeysFontSize, $2[50] = space, $2[51] = paddingProps, $2[52] = t23) : t23 = $2[52];
  let t24;
  $2[53] !== children || $2[54] !== paddingProps ? (t24 = children && (0, import_jsx_runtime.jsx)(Box, { as: "span", ...paddingProps, children }), $2[53] = children, $2[54] = paddingProps, $2[55] = t24) : t24 = $2[55];
  let t25;
  return $2[56] !== restProps || $2[57] !== t15 || $2[58] !== t16 || $2[59] !== t17 || $2[60] !== t18 || $2[61] !== as || $2[62] !== t19 || $2[63] !== t20 || $2[64] !== t21 || $2[65] !== scheme || $2[66] !== disabled || $2[67] !== handleClick || $2[68] !== onItemMouseEnter || $2[69] !== onItemMouseLeave || $2[70] !== t22 || $2[71] !== t23 || $2[72] !== t24 ? (t25 = (0, import_jsx_runtime.jsxs)(Selectable, { "data-ui": "MenuItem", ...restProps, "aria-pressed": t15, "data-pressed": t16, "data-selected": t17, "data-disabled": t18, forwardedAs: as, $radius: t19, $padding: t20, $tone: t21, $scheme: scheme, disabled, onClick: handleClick, onMouseEnter: onItemMouseEnter, onMouseLeave: onItemMouseLeave, ref: setRef, role: "menuitem", tabIndex: -1, type: t22, children: [
    t23,
    t24
  ] }), $2[56] = restProps, $2[57] = t15, $2[58] = t16, $2[59] = t17, $2[60] = t18, $2[61] = as, $2[62] = t19, $2[63] = t20, $2[64] = t21, $2[65] = scheme, $2[66] = disabled, $2[67] = handleClick, $2[68] = onItemMouseEnter, $2[69] = onItemMouseLeave, $2[70] = t22, $2[71] = t23, $2[72] = t24, $2[73] = t25) : t25 = $2[73], t25;
});
...
var Skeleton = (0, import_react48.forwardRef)(function(props, ref) {
  const $2 = (0, import_react_compiler_runtime.c)(14);
  let t0, delay2, radius, restProps;
  $2[0] !== props ? ({
    animated: t0,
    delay: delay2,
    radius,
    ...restProps
  } = props, $2[0] = props, $2[1] = t0, $2[2] = delay2, $2[3] = radius, $2[4] = restProps) : (t0 = $2[1], delay2 = $2[2], radius = $2[3], restProps = $2[4]);
  const animated = t0 === void 0 ? false : t0, [visible, setVisible] = (0, import_react48.useState)(!delay2);
  let t1, t2;
  $2[5] !== delay2 ? (t1 = () => {
    if (!delay2)
  ...
  }, t2 = [delay2], $2[5] = delay2, $2[6] = t1, $2[7] = t2) : (t1 = $2[6], t2 = $2[7]), (0, import_react48.useEffect)(t1, t2);
  const t3 = useArrayProp(radius);
  let t4;
  return $2[8] !== restProps || $2[9] !== animated || $2[10] !== t3 || $2[11] !== visible || $2[12] !== ref ? (t4 = (0, import_jsx_runtime.jsx)(Root$4, { ...restProps, $animated: animated, $radius: t3, $visible: visible, ref }), $2[8] = restProps, $2[9] = animated, $2[10] = t3, $2[11] = visible, $2[12] = ref, $2[13] = t4) : t4 = $2[13], t4;
});
...
var TextSkeleton = (0, import_react48.forwardRef)(function(props, ref) {
  const $2 = (0, import_react_compiler_runtime.c)(7);
  let t0, restProps;
  $2[0] !== props ? ({
    size: t0,
    ...restProps
  } = props, $2[0] = props, $2[1] = t0, $2[2] = restProps) : (t0 = $2[1], restProps = $2[2]);
  const $size = useArrayProp(t0 === void 0 ? 2 : t0);
  let t1;
  return $2[3] !== restProps || $2[4] !== $size || $2[5] !== ref ? (t1 = (0, import_jsx_runtime.jsx)(Root$3, { ...restProps, $size, ref, $style: "text" }), $2[3] = restProps, $2[4] = $size, $2[5] = ref, $2[6] = t1) : t1 = $2[6], t1;
});
TextSkeleton.displayName = "ForwardRef(TextSkeleton)";
var LabelSkeleton = (0, import_react48.forwardRef)(function(props, ref) {
  const $2 = (0, import_react_compiler_runtime.c)(7);
  let t0, restProps;
  $2[0] !== props ? ({
    size: t0,
  ...
  const $size = useArrayProp(t0 === void 0 ? 2 : t0);
  let t1;
  return $2[3] !== restProps || $2[4] !== $size || $2[5] !== ref ? (t1 = (0, import_jsx_runtime.jsx)(Root$3, { ...restProps, $size, ref, $style: "label" }), $2[3] = restProps, $2[4] = $size, $2[5] = ref, $2[6] = t1) : t1 = $2[6], t1;
});
LabelSkeleton.displayName = "ForwardRef(LabelSkeleton)";
var HeadingSkeleton = (0, import_react48.forwardRef)(function(props, ref) {
  const $2 = (0, import_react_compiler_runtime.c)(7);
  let t0, restProps;
  $2[0] !== props ? ({
    size: t0,
  ...
  const $size = useArrayProp(t0 === void 0 ? 2 : t0);
  let t1;
  return $2[3] !== restProps || $2[4] !== $size || $2[5] !== ref ? (t1 = (0, import_jsx_runtime.jsx)(Root$3, { ...restProps, $size, ref, $style: "heading" }), $2[3] = restProps, $2[4] = $size, $2[5] = ref, $2[6] = t1) : t1 = $2[6], t1;
});
HeadingSkeleton.displayName = "ForwardRef(HeadingSkeleton)";
var CodeSkeleton = (0, import_react48.forwardRef)(function(props, ref) {
  const $2 = (0, import_react_compiler_runtime.c)(7);
  let t0, restProps;
  $2[0] !== props ? ({
    size: t0,
  ...
  const $size = useArrayProp(t0 === void 0 ? 2 : t0);
  let t1;
  return $2[3] !== restProps || $2[4] !== $size || $2[5] !== ref ? (t1 = (0, import_jsx_runtime.jsx)(Root$3, { ...restProps, $size, ref, $style: "code" }), $2[3] = restProps, $2[4] = $size, $2[5] = ref, $2[6] = t1) : t1 = $2[6], t1;
});
CodeSkeleton.displayName = "ForwardRef(CodeSkeleton)";
var CustomButton = dt(Button)`
  max-width: 100%;
`;
var Tab = (0, import_react48.forwardRef)(function(props, forwardedRef) {
  const $2 = (0, import_react_compiler_runtime.c)(30);
  let t0, t1, onFocus, focused, selected, restProps, icon, id3, onClick, label;
  $2[0] !== props ? ({
    icon,
    id: id3,
    focused,
    ...
    selected,
    ...restProps
  } = props, $2[0] = props, $2[1] = t0, $2[2] = t1, $2[3] = onFocus, $2[4] = focused, $2[5] = selected, $2[6] = restProps, $2[7] = icon, $2[8] = id3, $2[9] = onClick, $2[10] = label) : (t0 = $2[1], t1 = $2[2], onFocus = $2[3], focused = $2[4], selected = $2[5], restProps = $2[6], icon = $2[7], id3 = $2[8], onClick = $2[9], label = $2[10]);
  const fontSize2 = t0 === void 0 ? 1 : t0, padding = t1 === void 0 ? 2 : t1, ref = (0, import_react48.useRef)(null), focusedRef = (0, import_react48.useRef)(false);
  let t2;
  $2[11] === Symbol.for("react.memo_cache_sentinel") ? (t2 = () => ref.current, $2[11] = t2) : t2 = $2[11], (0, import_react48.useImperativeHandle)(forwardedRef, t2);
  let t3;
  ...
  }, t6 = [focused], $2[15] = focused, $2[16] = t5, $2[17] = t6) : (t5 = $2[16], t6 = $2[17]), (0, import_react48.useEffect)(t5, t6);
  const t7 = selected ? "true" : "false", t8 = selected ? 0 : -1;
  let t9;
  return $2[18] !== restProps || $2[19] !== t7 || $2[20] !== fontSize2 || $2[21] !== icon || $2[22] !== id3 || $2[23] !== onClick || $2[24] !== handleFocus || $2[25] !== padding || $2[26] !== selected || $2[27] !== t8 || $2[28] !== label ? (t9 = (0, import_jsx_runtime.jsx)(CustomButton, { "data-ui": "Tab", ...restProps, "aria-selected": t7, fontSize: fontSize2, icon, id: id3, mode: "bleed", onClick, onBlur: handleBlur, onFocus: handleFocus, padding, ref, role: "tab", selected, tabIndex: t8, text: label, type: "button" }), $2[18] = restProps, $2[19] = t7, $2[20] = fontSize2, $2[21] = icon, $2[22] = id3, $2[23] = onClick, $2[24] = handleFocus, $2[25] = padding, $2[26] = selected, $2[27] = t8, $2[28] = label, $2[29] = t9) : t9 = $2[29], t9;
});
...
`;
var TabList = (0, import_react48.forwardRef)(function(props, ref) {
  ...
  if ($2[3] !== childrenProp || $2[4] !== focusedIndex) {
    const children = import_react48.Children.toArray(childrenProp).filter(import_react48.isValidElement);
    let t12;
    $2[6] !== focusedIndex ? (t12 = (child, childIndex) => (0, import_react48.cloneElement)(child, {
  ...
  const handleKeyDown = t1;
  let t2;
  return $2[10] !== restProps || $2[11] !== handleKeyDown || $2[12] !== ref || $2[13] !== tabs ? (t2 = (0, import_jsx_runtime.jsx)(CustomInline, { "data-ui": "TabList", ...restProps, onKeyDown: handleKeyDown, ref, role: "tablist", children: tabs }), $2[10] = restProps, $2[11] = handleKeyDown, $2[12] = ref, $2[13] = tabs, $2[14] = t2) : t2 = $2[14], t2;
});
TabList.displayName = "ForwardRef(TabList)";
var TabPanel = (0, import_react48.forwardRef)(function(props, ref) {
  const $2 = (0, import_react_compiler_runtime.c)(9);
  let restProps, flex;
  $2[0] !== props ? ({
    flex,
    ...restProps
  } = props, $2[0] = props, $2[1] = restProps, $2[2] = flex) : (restProps = $2[1], flex = $2[2]);
  const t0 = props.tabIndex === void 0 ? 0 : props.tabIndex;
  let t1;
  return $2[3] !== restProps || $2[4] !== flex || $2[5] !== ref || $2[6] !== t0 || $2[7] !== props.children ? (t1 = (0, import_jsx_runtime.jsx)(Box, { "data-ui": "TabPanel", ...restProps, flex, ref, role: "tabpanel", tabIndex: t0, children: props.children }), $2[3] = restProps, $2[4] = flex, $2[5] = ref, $2[6] = t0, $2[7] = props.children, $2[8] = t1) : t1 = $2[8], t1;
});
...
function Toast(props) {
  ...
  $2[0] !== props ? ({
    ...
    status,
    ...restProps
  } = props, $2[0] = props, $2[1] = t0, $2[2] = status, $2[3] = title, $2[4] = description, $2[5] = closable, $2[6] = onClose, $2[7] = restProps, $2[8] = duration) : (t0 = $2[1], status = $2[2], title = $2[3], description = $2[4], closable = $2[5], onClose = $2[6], restProps = $2[7], duration = $2[8]);
  ...
  let t1;
  $2[9] !== title ? (t1 = title && (0, import_jsx_runtime.jsx)(Text, { size: 1, weight: "medium", children: title }), $2[9] = title, $2[10] = t1) : t1 = $2[10];
  let t2;
  $2[11] !== description ? (t2 = description && (0, import_jsx_runtime.jsx)(Text, { muted: true, size: 1, children: description }), $2[11] = description, $2[12] = t2) : t2 = $2[12];
  let t3;
  $2[13] !== t1 || $2[14] !== t2 ? (t3 = (0, import_jsx_runtime.jsx)(TextBox, { flex: 1, padding: 3, children: (0, import_jsx_runtime.jsxs)(Stack, { space: 3, children: [
    t1,
    t2
  ] }) }), $2[13] = t1, $2[14] = t2, $2[15] = t3) : t3 = $2[15];
  let t4;
  $2[16] !== closable || $2[17] !== buttonTone || $2[18] !== onClose ? (t4 = closable && (0, import_jsx_runtime.jsx)(Box, { padding: 1, children: (0, import_jsx_runtime.jsx)(Button, { as: "button", icon: CloseIcon, mode: "bleed", padding: 2, tone: buttonTone, onClick: onClose, style: {
    verticalAlign: "top"
  } }) }), $2[16] = closable, $2[17] = buttonTone, $2[18] = onClose, $2[19] = t4) : t4 = $2[19];
  let t5;
  $2[20] !== t3 || $2[21] !== t4 ? (t5 = (0, import_jsx_runtime.jsxs)(Flex, { align: "flex-start", children: [
    t3,
    t4
  ] }), $2[20] = t3, $2[21] = t4, $2[22] = t5) : t5 = $2[22];
  let t6;
  return $2[23] !== role || $2[24] !== restProps || $2[25] !== radius || $2[26] !== cardTone || $2[27] !== duration || $2[28] !== t5 ? (t6 = (0, import_jsx_runtime.jsx)(Root$2, { "data-ui": "Toast", role, ...restProps, marginTop: 3, radius, shadow: 2, tone: cardTone, $duration: duration, children: t5 }), $2[23] = role, $2[24] = restProps, $2[25] = radius, $2[26] = cardTone, $2[27] = duration, $2[28] = t5, $2[29] = t6) : t6 = $2[29], t6;
}
Toast.displayName = "Toast";
function useMounted() {
  return (0, import_react48.useSyncExternalStore)(subscribe, _temp, _temp2);
}
function _temp2() {
  return false;
}
...
function ToastProvider(props) {
  const {
    ...
    paddingY,
    zOffset
  } = props, [state, _setState] = (0, import_react48.useState)([]), toastsRef = (0, import_react48.useRef)({}), mounted = useMounted(), prefersReducedMotion2 = usePrefersReducedMotion(), variants = (0, import_react48.useMemo)(() => ({
    initial: {
      opacity: 0,
      [POPOVER_MOTION_CONTENT_OPACITY_PROPERTY]: 0,
      y: 32,
    ...
    exit: {
      ...
      scale: 0.5,
      transition: prefersReducedMotion2 ? {
        duration: 0
      } : {
        duration: 0.2
      }
    }
  }), [prefersReducedMotion2]), value = (0, import_react48.useMemo)(() => ({
    version: 0,
    push: (params) => {
      const setState = (state_0) => (0, import_react48.startTransition)(() => _setState(state_0)), id3 = params.id || String(toastId++), duration = params.duration || 5e3, dismiss = () => {
        var _a;
  ...
  return (0, import_react48.useEffect)(() => () => {
    ...
    toastsRef.current = {};
  }, []), (0, import_jsx_runtime.jsxs)(ToastContext.Provider, { value, children: [
    children,
    mounted && (0, import_jsx_runtime.jsx)(Root$1, { "data-ui": "ToastProvider", zOffset, children: (0, import_jsx_runtime.jsx)(ToastContainer, { children: (0, import_jsx_runtime.jsx)(Box, { padding, paddingX, paddingY, children: (0, import_jsx_runtime.jsx)(AnimatePresence, { initial: false, children: state.map(({
      dismiss: dismiss_0,
      id: id_0,
      params: params_0
    }) => (0, import_jsx_runtime.jsx)(motion.div, { layout: "position", initial: "initial", animate: "animate", exit: "exit", variants, transition: prefersReducedMotion2 ? {
      duration: 0
    } : {
      type: "spring",
      damping: 30,
      stiffness: 400
    }, children: (0, import_jsx_runtime.jsx)(Toast, { closable: params_0.closable, description: params_0.description, onClose: dismiss_0, status: params_0.status, title: params_0.title, duration: params_0.duration }) }, id_0)) }) }) }) })
  ] });
}
ToastProvider.displayName = "ToastProvider";
function useToast() {
  const value = (0, import_react48.useContext)(ToastContext);
  if (!value)
...
var Tree = (0, import_react48.memo)((0, import_react48.forwardRef)(function(props, forwardedRef) {
  ...
  $2[0] !== props ? ({
    ...
    onFocus,
    ...restProps
  } = props, $2[0] = props, $2[1] = t0, $2[2] = onFocus, $2[3] = children, $2[4] = restProps) : (t0 = $2[1], onFocus = $2[2], children = $2[3], restProps = $2[4]);
  const space = t0 === void 0 ? 1 : t0, ref = (0, import_react48.useRef)(null), [focusedElement, setFocusedElement] = (0, import_react48.useState)(null), focusedElementRef = (0, import_react48.useRef)(focusedElement);
  let t1, t2;
  $2[5] === Symbol.for("react.memo_cache_sentinel") ? (t2 = [], $2[5] = t2) : t2 = $2[5], t1 = t2;
  const path = t1;
  let t3;
  $2[6] === Symbol.for("react.memo_cache_sentinel") ? (t3 = [], $2[6] = t3) : t3 = $2[6];
  const [itemElements, setItemElements] = (0, import_react48.useState)(t3);
  let t4;
  $2[7] === Symbol.for("react.memo_cache_sentinel") ? (t4 = {}, $2[7] = t4) : t4 = $2[7];
  const [state, setState] = (0, import_react48.useState)(t4), stateRef = (0, import_react48.useRef)(state);
  let t5;
  $2[8] === Symbol.for("react.memo_cache_sentinel") ? (t5 = () => ref.current, $2[8] = t5) : t5 = $2[8], (0, import_react48.useImperativeHandle)(forwardedRef, t5);
  let t6, t7;
  $2[9] !== focusedElement ? (t6 = () => {
    focusedElementRef.current = focusedElement;
  }, t7 = [focusedElement], $2[9] = focusedElement, $2[10] = t6, $2[11] = t7) : (t6 = $2[10], t7 = $2[11]), (0, import_react48.useEffect)(t6, t7);
  let t8, t9;
  $2[12] !== state ? (t8 = () => {
    stateRef.current = state;
  }, t9 = [state], $2[12] = state, $2[13] = t8, $2[14] = t9) : (t8 = $2[13], t9 = $2[14]), (0, import_react48.useEffect)(t8, t9);
  let t10;
  ...
  let t14;
  $2[17] !== t13 || $2[18] !== space || $2[19] !== state ? (t14 = {
    version: 0,
    focusedElement: t13,
    level: 0,
    path,
    ...
    space,
    state
  }, $2[17] = t13, $2[18] = space, $2[19] = state, $2[20] = t14) : t14 = $2[20], t12 = t14;
  ...
  let t18;
  $2[26] !== children ? (t18 = [children], $2[26] = children, $2[27] = t18) : t18 = $2[27], (0, import_react48.useEffect)(t17, t18);
  let t19;
  $2[28] !== restProps || $2[29] !== handleFocus || $2[30] !== handleKeyDown || $2[31] !== space || $2[32] !== children ? (t19 = (0, import_jsx_runtime.jsx)(Stack, { as: "ul", "data-ui": "Tree", ...restProps, onFocus: handleFocus, onKeyDown: handleKeyDown, ref, role: "tree", space, children }), $2[28] = restProps, $2[29] = handleFocus, $2[30] = handleKeyDown, $2[31] = space, $2[32] = children, $2[33] = t19) : t19 = $2[33];
  let t20;
  return $2[34] !== contextValue || $2[35] !== t19 ? (t20 = (0, import_jsx_runtime.jsx)(TreeContext.Provider, { value: contextValue, children: t19 }), $2[34] = contextValue, $2[35] = t19, $2[36] = t20) : t20 = $2[36], t20;
}));
...
function useTree() {
  const tree = (0, import_react48.useContext)(TreeContext);
  if (!tree)
    throw new Error("Tree: missing context value");
  return tree;
}
var TreeGroup = (0, import_react48.memo)(function(props) {
  const $2 = (0, import_react_compiler_runtime.c)(9);
  let t0, restProps, children;
  $2[0] !== props ? ({
    children,
  ...
  let t2;
  return $2[4] !== restProps || $2[5] !== t1 || $2[6] !== tree.space || $2[7] !== children ? (t2 = (0, import_jsx_runtime.jsx)(Stack, { as: "ul", "data-ui": "TreeGroup", ...restProps, hidden: t1, marginTop: tree.space, role: "group", space: tree.space, children }), $2[4] = restProps, $2[5] = t1, $2[6] = tree.space, $2[7] = children, $2[8] = t2) : t2 = $2[8], t2;
});
var Root = (0, import_react48.memo)(dt.li(treeItemRootStyle, treeItemRootColorStyle));
...
`;
var TreeItem = (0, import_react48.memo)(function(props) {
  const {
    children,
    ...
    weight,
    ...restProps
  } = props, rootRef = (0, import_react48.useRef)(null), treeitemRef = (0, import_react48.useRef)(null), tree = useTree(), {
    path,
    registerItem,
    setExpanded,
    setFocusedElement
  } = tree, _id = (0, import_react48.useId)(), id3 = idProp || _id, itemPath = (0, import_react48.useMemo)(() => path.concat([id3 || ""]), [id3, path]), itemKey = itemPath.join("/"), itemState = tree.state[itemKey], focused = tree.focusedElement === rootRef.current, expanded = (itemState == null ? void 0 : itemState.expanded) === void 0 ? expandedProp : (itemState == null ? void 0 : itemState.expanded) || false, tabIndex = tree.focusedElement && tree.focusedElement === rootRef.current ? 0 : -1, contextValue = (0, import_react48.useMemo)(() => ({
    ...tree,
    level: tree.level + 1,
    path: itemPath
  }), [itemPath, tree]), handleClick = (0, import_react48.useCallback)((event) => {
  ...
  }, [expanded, itemKey, onClick, setExpanded, setFocusedElement]), handleKeyDown = (0, import_react48.useCallback)((event_0) => {
    var _a;
  ...
  const content = (0, import_jsx_runtime.jsxs)(Flex, { padding, children: [
    (0, import_jsx_runtime.jsxs)(Box, { marginRight: space, style: {
      visibility: IconComponent || children ? "visible" : "hidden",
      pointerEvents: "none"
    }, children: [
      IconComponent && (0, import_jsx_runtime.jsx)(Text, { muted, size: fontSize2, weight, children: (0, import_jsx_runtime.jsx)(IconComponent, {}) }),
      !IconComponent && (0, import_jsx_runtime.jsx)(ToggleArrowText, { muted, size: fontSize2, weight, children: (0, import_jsx_runtime.jsx)(ToggleArrowRightIcon, { style: {
        transform: expanded ? "rotate(90deg)" : void 0
      } }) })
    ] }),
    (0, import_jsx_runtime.jsx)(Box, { flex: 1, children: (0, import_jsx_runtime.jsx)(Text, { muted, size: fontSize2, textOverflow: "ellipsis", weight, children: text }) })
  ] });
  return href ? (0, import_jsx_runtime.jsxs)(Root, { "data-selected": selected ? "" : void 0, "data-tree-id": id3, "data-tree-key": itemKey, "data-ui": "TreeItem", ...restProps, onClick: handleClick, ref: rootRef, role: "none", children: [
    (0, import_jsx_runtime.jsx)(TreeItemBox, { $level: tree.level, "aria-expanded": expanded, as: linkAs, "data-ui": "TreeItem__box", href, ref: treeitemRef, role: "treeitem", tabIndex, children: content }),
    (0, import_jsx_runtime.jsx)(TreeContext.Provider, { value: contextValue, children: children && (0, import_jsx_runtime.jsx)(TreeGroup, { hidden: !expanded, children }) })
  ] }) : (0, import_jsx_runtime.jsxs)(Root, { "data-selected": selected ? "" : void 0, "data-ui": "TreeItem", "data-tree-id": id3, "data-tree-key": itemKey, ...restProps, "aria-expanded": expanded, onClick: handleClick, onKeyDown: handleKeyDown, ref: rootRef, role: "treeitem", tabIndex, children: [
    (0, import_jsx_runtime.jsx)(TreeItemBox, { $level: tree.level, as: "div", "data-ui": "TreeItem__box", children: content }),
    (0, import_jsx_runtime.jsx)(TreeContext.Provider, { value: contextValue, children: children && (0, import_jsx_runtime.jsx)(TreeGroup, { expanded, children }) })
  ] });
});
...
react-compiler-runtime/dist/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-PCDQS5XE.js.map
